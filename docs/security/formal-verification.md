...
**Goal (north star):** provide a machine-checked argument that RemoteClaw enforces its
...
**What this is not (yet):** a proof that “RemoteClaw is secure in all respects” or that the full TypeScript implementation is correct.
