...
```
  ...
  <TabItem label="Mentions and group DMs">
...
## Developer Portal setup
  ...
  <details>
<summary>Create app and bot</summary>
  ...
  <details>
<summary>Privileged intents</summary>
  ...
  <details>
<summary>OAuth scopes and baseline permissions</summary>
...
## Feature details
  ...
  <details>
<summary>Reply tags and native replies</summary>
  ...
  <details>
<summary>Live stream preview</summary>
...
```
  ...
  <details>
<summary>History, context, and thread behavior</summary>
  ...
  <details>
<summary>Thread-bound sessions for subagents</summary>
...
```
  ...
  <details>
<summary>PluralKit support</summary>
...
RemoteClaw uses Discord components v2 for cross-context markers. Discord message actions can also accept `components` for custom UI (advanced; requires Carbon component instances), while legacy `embeds` remain available but are not recommended.
...
## Troubleshooting
  ...
  <details>
<summary>Used disallowed intents or bot sees no guild messages</summary>
  ...
  <details>
<summary>Guild messages blocked unexpectedly</summary>
...
```
  ...
  <details>
<summary>Require mention false but still blocked</summary>
  ...
  <details>
<summary>Permissions audit mismatches</summary>
  ...
  <details>
<summary>DM and pairing issues</summary>
  ...
  <details>
<summary>Bot to bot loops</summary>
  ...
  <details>
<summary>Voice STT drops with DecryptionFailed(...)</summary>
...
- features: `pluralkit`, `intents`, `agentComponents`, `heartbeat`, `responsePrefix`
