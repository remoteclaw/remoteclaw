...
like RemoteClaw. The setup wizard can run the OAuth flow for you.
...
The setup wizard accepts `@username` input and resolves it to a numeric ID, but RemoteClaw authorization uses numeric IDs only.
