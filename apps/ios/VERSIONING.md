# RemoteClaw iOS Versioning

RemoteClaw iOS release uploads use an explicit CalVer release version. The
...
```text
refs/remoteclaw/mobile-releases/ios/<CFBundleShortVersionString>-<CFBundleVersion>
```

Example:

```text
refs/remoteclaw/mobile-releases/ios/2026.6.11-3
```
