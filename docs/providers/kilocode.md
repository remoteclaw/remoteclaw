...
read_when:
  ...
  - You want to run models via Kilo Gateway in RemoteClaw
---
...
```bash
remoteclaw onboard --kilocode-api-key <key>
```
...
RemoteClaw dynamically discovers available models from the Kilo Gateway at startup. Use
