...
export const FIELD_HELP: Record<string, string> = {
  ...
  "browser.profiles.*.driver":
    'Per-profile browser driver mode. Use "remoteclaw" (or legacy "clawd") for CDP-based profiles, or use "existing-session" for host-local Chrome DevTools MCP attachment.',
