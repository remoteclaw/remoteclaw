...
function resolveChannelCatalogPluginId(
  ...
  // The fork's PluginCandidate exposes only `idHint` as the derived plugin id;
  // the upstream bundledManifest/packageManifest.plugin id sources were gutted.
  return resolveOptionalString(candidate.idHint);
}
