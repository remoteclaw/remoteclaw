...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: RemoteClawProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": RemoteClawProtocol.AnyCodable("start"),
                "name": RemoteClawProtocol.AnyCodable("bash"),
            ],
            summary: nil)
