...
function getDiagnosticStabilityState(): DiagnosticStabilityState {
  const globalStore = globalThis as typeof globalThis & {
    __remoteclawDiagnosticStabilityState?: DiagnosticStabilityState;
  };
  globalStore.__remoteclawDiagnosticStabilityState ??= createState();
  return globalStore.__remoteclawDiagnosticStabilityState;
}
...
export function resetDiagnosticStabilityRecorderForTest(): void {
  ...
  globalStore.__remoteclawDiagnosticStabilityState = next;
}
