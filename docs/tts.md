...
It works anywhere RemoteClaw can send audio; Telegram gets a round voice-note bubble.
...
RemoteClaw defaults to Microsoft (unless disabled via
...
reply delivery. When the result is Telegram-compatible, RemoteClaw marks it for
