---
description: "WhatsApp channel support, access controls, delivery behavior, and operations"
read_when:
...
<CardGrid>
  <Card title="Pairing">
    Default DM policy is pairing for unknown senders. [Pairing docs](/channels/pairing)
  </Card>
  <Card title="Channel troubleshooting">
    Cross-channel diagnostics and repair playbooks. [Troubleshooting
    docs](/channels/troubleshooting)
  </Card>
  <Card title="Gateway configuration">
    Full channel config patterns and examples. [Configuration docs](/gateway/configuration)
  </Card>
</CardGrid>
...
:::note
RemoteClaw recommends running WhatsApp on a separate number when possible. (The channel metadata and
...
<details>
<summary>Dedicated number (recommended)</summary>
...
<details>
<summary>Personal-number fallback</summary>
...
<details>
<summary>WhatsApp Web-only channel scope</summary>
...
<Tabs>
  ...
  <TabItem label="Group policy + allowlists">
  ...
  <TabItem label="Mentions + /activation">
...
<details>
<summary>Inbound envelope + reply context</summary>
...
<details>
<summary>Media placeholders and location/contact extraction</summary>
...
<details>
<summary>Pending group history injection</summary>
...
<details>
<summary>Outbound media behavior</summary>
...
<details>
<summary>Media size limits and fallback behavior</summary>
...
<details>
<summary>Account selection and defaults</summary>
...
<details>
<summary>Credential paths and legacy compatibility</summary>
...
<details>
<summary>Logout behavior</summary>
...
<details>
<summary>Not linked (QR required)</summary>
...
<details>
<summary>Linked but disconnected / reconnect loop</summary>
...
<details>
<summary>No active listener when sending</summary>
...
<details>
<summary>Group messages unexpectedly ignored</summary>
...
<details>
<summary>Bun runtime warning</summary>
