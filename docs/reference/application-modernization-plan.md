...
modernization task. If adopting this guidance as a repo-local RemoteClaw skill,
create `.agents/skills/remoteclaw-frontend/SKILL.md` first, keep the frontmatter
