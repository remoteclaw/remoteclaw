...
class ChatMarkdownTest {
  ...
  fun markdownLinksUseLabelTextAndDestinationUrl() {
    val annotated = buildChatInlineMarkdown("Open [docs](https://docs.remoteclaw.org/help/testing) now")
    ...
    assertEquals("https://docs.remoteclaw.org/help/testing", (links.single().item as LinkAnnotation.Url).url)
  }
