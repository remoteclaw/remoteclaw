...
vi.mock("remoteclaw/plugin-sdk/web-media", async () => {
...
let loadWebMedia: typeof import("remoteclaw/plugin-sdk/web-media").loadWebMedia;
...
beforeEach(async () => {
  ...
  ({ loadWebMedia } = await import("remoteclaw/plugin-sdk/web-media"));
