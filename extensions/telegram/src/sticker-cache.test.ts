...
const TEST_CACHE_DIR = "/tmp/remoteclaw-test-sticker-cache/telegram";
...
describe("sticker-cache", () => {
  beforeEach(async () => {
    process.env.OPENCLAW_STATE_DIR = "/tmp/remoteclaw-test-sticker-cache";
    fs.rmSync("/tmp/remoteclaw-test-sticker-cache", { recursive: true, force: true });
