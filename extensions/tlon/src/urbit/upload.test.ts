...
vi.mock("remoteclaw/plugin-sdk/compat", async (importOriginal) => {
  const actual = await importOriginal<typeof import("remoteclaw/plugin-sdk/compat")>();
  return {
    ...actual,
...
describe("uploadImageFromUrl", () => {
  ...
  it("fetches image and calls uploadFile, returns uploaded URL", async () => {
    const { fetchWithSsrFGuard } = await import("remoteclaw/plugin-sdk/compat");
