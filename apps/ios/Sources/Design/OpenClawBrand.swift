...
enum AppAppearancePreference: String, CaseIterable, Identifiable {
    ...
    static var launchArgumentPreference: AppAppearancePreference? {
        ...
        guard let flagIndex = arguments.firstIndex(of: "--remoteclaw-appearance") else {
            return nil
        }
...
extension View {
    func remoteClawSheetChrome() -> some View {
        self
            .tint(RemoteClawBrand.accent)
            .background {
                RemoteClawBrand.sheetBackground
                    .ignoresSafeArea()
            }
    }
}
