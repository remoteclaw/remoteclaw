...
export const id: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      qrAlt: "Kode QR pemasangan RemoteClaw seluler",
      ...
      review: "Tinjau",
      waiting: "Aplikasi seluler resmi RemoteClaw terhubung otomatis setelah dipindai.",
  ...
  worktrees: {
    ...
    subtitle: "Checkout repositori terisolasi yang dimiliki oleh RemoteClaw.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Di seluler? Salin URL lengkap (termasuk #token=...) dari remoteclaw dashboard --no-open di desktop Anda.",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Tempel token dari remoteclaw dashboard --no-open atau masukkan kata sandi yang dikonfigurasi.",
        stepGenerate:
          "Jika belum ada token yang dikonfigurasi, jalankan remoteclaw doctor --generate-gateway-token di host Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Jalankan remoteclaw dashboard --no-open lalu buka URL baru atau tempel tokennya.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Jalankan remoteclaw devices list di host Gateway.",
        stepApproveId: "Setujui permintaan ini: remoteclaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Buka kembali dashboard yang disajikan dengan remoteclaw dashboard agar UI dan Gateway berasal dari instalasi yang sama.",
        stepDevUi:
          "Jika menggunakan pnpm ui:dev, bangun ulang atau mulai ulang UI dev terhadap checkout saat ini.",
        stepRestart:
          "Mulai ulang Gateway setelah memperbarui RemoteClaw agar menyajikan protokol saat ini.",
      },
      network: {
        ...
        stepGateway:
          "Pastikan Gateway berjalan dengan remoteclaw status atau remoteclaw gateway run.",
        stepUrl:
          "Periksa URL WebSocket dan gunakan wss:// saat Gateway berada di belakang HTTPS/Tailscale Serve.",
        stepDashboard:
          "Buka kembali dashboard dengan remoteclaw dashboard --no-open untuk menyalin ulang URL dan detail auth saat ini.",
      },
    },
  },
  connection: {
