  ...
  try {
    return await new Promise<ProbeApnsHttp2ReachabilityViaProxyResult>((resolve, reject) => {
      ...
      const request = session.request({
        ...
        authorization: "bearer intentionally.invalid.remoteclaw.proxy.validation",
        "apns-topic": "org.remoteclaw.ios",
      ...
      request.end(JSON.stringify({ aps: { alert: "RemoteClaw APNs proxy validation" } }));
    });
  } finally {
