...
export type RemoteClawManifestRequires = {
  bins: string[];
  anyBins: string[];
  env: string[];
  config: string[];
...
export type ParsedRemoteClawManifestInstallBase = {
...
export function parseRemoteClawManifestInstallBase(
...
): ParsedRemoteClawManifestInstallBase | undefined {
  ...
  const spec: ParsedRemoteClawManifestInstallBase = {
    raw,
    kind,
  };
