export { HEARTBEAT_PROMPT, stripHeartbeatToken } from "remoteclaw/plugin-sdk/reply-runtime";
export { HEARTBEAT_TOKEN, SILENT_REPLY_TOKEN } from "remoteclaw/plugin-sdk/reply-runtime";
