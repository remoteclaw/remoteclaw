...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']remoteclaw\/plugin-sdk["']/,
    hint: "Use remoteclaw/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']remoteclaw\/plugin-sdk\/test-utils["']/,
    hint: "Use remoteclaw/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']remoteclaw\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/extensions/* for repo-only helpers, or remoteclaw/plugin-sdk/testing for public surfaces.",
  },
  {
