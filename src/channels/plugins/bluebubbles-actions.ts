...
const BLUEBUBBLES_ACTION_SPECS = BLUEBUBBLES_ACTIONS as Record<keyof typeof BLUEBUBBLES_ACTIONS, BlueBubblesActionSpec>;

export const BLUEBUBBLES_ACTION_NAMES = Object.keys(BLUEBUBBLES_ACTIONS) as (keyof typeof BLUEBUBBLES_ACTIONS)[];
