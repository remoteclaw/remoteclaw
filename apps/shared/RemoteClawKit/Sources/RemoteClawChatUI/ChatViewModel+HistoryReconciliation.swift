...
extension RemoteClawChatViewModel {
    static func decodeMessages(_ raw: [AnyCodable]) -> [RemoteClawChatMessage] {
    ...
    static func stripInboundMetadata(from message: RemoteClawChatMessage) -> RemoteClawChatMessage {
    ...
    static func messageContentFingerprint(for message: RemoteClawChatMessage) -> String {
    ...
    static func finalMessageContentFingerprint(for message: RemoteClawChatMessage) -> String {
        message.content.map { item in
            let type = (item.type ?? "text").trimmingCharacters(in: .whitespacesAndNewlines).lowercased()
            let text = (item.text ?? "").trimmingCharacters(in: .whitespacesAndNewlines)
    ...
    static func messageIdentityKey(for message: RemoteClawChatMessage) -> String? {
    ...
    static func userRefreshIdentityKey(for message: RemoteClawChatMessage) -> String? {
        let role = message.role.trimmingCharacters(in: .whitespacesAndNewlines).lowercased()
    ...
    static func finalMessageReconciliationKey(for message: RemoteClawChatMessage) -> String? {
        let role = message.role.trimmingCharacters(in: .whitespacesAndNewlines).lowercased()
    ...
    static func adoptingCanonicalMessage(
        _ incoming: RemoteClawChatMessage,
        over existing: RemoteClawChatMessage) -> RemoteClawChatMessage
    {
    ...
    private static func preservingLocalAudioDurations(
        in incoming: [RemoteClawChatMessageContent],
        from existing: [RemoteClawChatMessageContent]) -> [RemoteClawChatMessageContent]
    {
    ...
    static func containsUserTurn(
        ...
        in messages: [RemoteClawChatMessage]) -> Bool
    {
    ...
    static func indexAfterLatestUserTurn(
        _ latestUserTurn: LatestUserTurn?,
        in messages: [RemoteClawChatMessage])
        -> [RemoteClawChatMessage].Index
    {
    ...
    static func messageRange(
        ...
        in messages: [RemoteClawChatMessage]) -> Range<[RemoteClawChatMessage].Index>
    {
    ...
    func adoptingProvisionalFinalMessageIDs(
        in incoming: [RemoteClawChatMessage]) -> [RemoteClawChatMessage]
    {
    ...
    func clearProvisionalFinalMarkersAdoptedByHistory(_ incoming: [RemoteClawChatMessage]) {
    ...
    func adoptCorrelatedUserMessage(incoming: RemoteClawChatMessage) -> Bool {
    ...
    func adoptProvisionalFinalMessage(incoming: RemoteClawChatMessage) -> Bool {
        ...
        incoming: [RemoteClawChatMessage]) -> [RemoteClawChatMessage]
    {
        ...
        var previousMessagesByKey: [String: [RemoteClawChatMessage]] = [:]
    ...
    static func reconcileRunRefreshMessages(
        previous: [RemoteClawChatMessage],
        incoming: [RemoteClawChatMessage],
        pendingLocalUserEchoIDs: Set<UUID>) -> [RemoteClawChatMessage]
    {
    ...
    static func dedupeMessages(_ messages: [RemoteClawChatMessage]) -> [RemoteClawChatMessage] {
    ...
    static func dedupeKey(for message: RemoteClawChatMessage) -> String? {
