...
function createTooltipId() {
  nextTooltipId += 1;
  return `remoteclaw-tooltip-${nextTooltipId}`;
}
...
class Tooltip extends LitElement {
  ...
  private get provider() {
    return this.closest<TooltipProvider>("remoteclaw-tooltip-provider");
  }
  ...
  private show() {
    ...
    this.portal.className = "remoteclaw-tooltip";
...
if (!customElements.get("remoteclaw-tooltip-provider")) {
  customElements.define("remoteclaw-tooltip-provider", TooltipProvider);
}

if (!customElements.get("remoteclaw-tooltip")) {
  customElements.define("remoteclaw-tooltip", Tooltip);
}
