...
import { loadRemoteClawPluginCliRegistry, loadRemoteClawPlugins } from "./loader.js";
import {
...
describe("plugin loader CLI metadata", () => {
  ...
  register(api) {
    ...
    const registry = await loadRemoteClawPluginCliRegistry({
  ...
  register(api) {
    ...
    fs.writeFileSync(
      path.join(plugin.dir, "remoteclaw.plugin.json"),
      JSON.stringify(
        {
          id: "config-cli",
          configSchema: {
  ...
  it("uses the real channel entry in cli-metadata mode for CLI metadata capture", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@remoteclaw/cli-metadata-channel",
          remoteclaw: { extensions: ["./index.cjs"], setupEntry: "./setup-entry.cjs" },
        },
        null,
        2,
      ),
...
module.exports = {
  ...
  it("skips bundled channel full entries that do not provide a dedicated cli-metadata entry", async () => {
    ...
    process.env.REMOTECLAW_BUNDLED_PLUGINS_DIR = bundledRoot;

    fs.writeFileSync(
      path.join(pluginDir, "package.json"),
      JSON.stringify(
        {
          name: "@remoteclaw/bundled-skip-channel",
          remoteclaw: { extensions: ["./index.cjs"] },
        },
        null,
        2,
      ),
...
module.exports = {
  ...
  it("prefers bundled channel cli-metadata entries over full channel entries", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@remoteclaw/bundled-cli-channel",
          remoteclaw: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  it("skips bundled non-channel full entries that do not provide a dedicated cli-metadata entry", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@remoteclaw/bundled-skip-provider",
          remoteclaw: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  it("collects channel CLI metadata during full plugin loads", () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@remoteclaw/full-cli-metadata-channel",
          remoteclaw: { extensions: ["./index.cjs"] },
        },
        null,
        2,
