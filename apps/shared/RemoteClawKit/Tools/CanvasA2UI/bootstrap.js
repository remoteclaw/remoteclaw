...
import "@a2ui/lit/ui";
import { themeContext } from "@remoteclaw/a2ui-theme-context";
...
class RemoteClawA2UIHost extends LitElement {
  static properties = {
    surfaces: { state: true },
...
if (!customElements.get("remoteclaw-a2ui-host")) {
  customElements.define("remoteclaw-a2ui-host", RemoteClawA2UIHost);
}
