...
enum SessionMenuPreviewLoader {
    private static let logger = Logger(subsystem: "ai.remoteclaw", category: "SessionPreview")
    ...
    private static func requestPreview(
        keys: [String],
        maxItems: Int) async throws -> RemoteClawSessionsPreviewPayload
    {
    ...
    private static func snapshot(
        from entry: RemoteClawSessionPreviewEntry,
    ...
    private static func cache(payload: RemoteClawSessionsPreviewPayload, maxItems: Int) async {
    ...
    private static func previewItems(
        from payload: RemoteClawChatHistoryPayload,
        maxItems: Int) -> [SessionPreviewItem]
    {
        let boundedItems = self.normalizeMaxItems(maxItems)
        let raw: [RemoteClawKit.AnyCodable] = payload.messages ?? []
    ...
    private static func decodeMessages(_ raw: [RemoteClawKit.AnyCodable]) -> [RemoteClawChatMessage] {
    ...
    private static func previewText(for message: RemoteClawChatMessage) -> String? {
    ...
    private static func isToolCall(_ message: RemoteClawChatMessage) -> Bool {
    ...
    private static func toolNames(for message: RemoteClawChatMessage) -> [String] {
        var names: [String] = []
    ...
    private static func mediaSummary(for message: RemoteClawChatMessage) -> String? {
