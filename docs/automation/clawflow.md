...
- Use `remoteclaw flows list`, `remoteclaw flows show`, and `remoteclaw flows cancel` to inspect or manage flows.

## Quick start

```bash
remoteclaw flows list
remoteclaw flows show <flow-id-or-owner-session>
remoteclaw flows cancel <flow-id-or-owner-session>
```
...
- `remoteclaw flows list` shows active and recent flows
- `remoteclaw flows show <lookup>` shows one flow and its linked tasks
- `remoteclaw flows cancel <lookup>` cancels the flow and any active child tasks
