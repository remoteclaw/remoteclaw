...
@Suite struct ScreenControllerTests {
    ...
    @Test @MainActor func trustedRemoteA2UIURLMustMatchExactly() {
        let screen = ScreenController()
        let trusted = "https://node.ts.net:18789/__remoteclaw__/a2ui/?platform=ios"
        ...
        #expect(screen.isTrustedCanvasUIURL(URL(string: "https://node.ts.net:18789/__remoteclaw__/a2ui/?platform=ios#step2")!) == true)
        #expect(screen.isTrustedCanvasUIURL(URL(string: "https://node.ts.net:18789/__remoteclaw__/a2ui/?platform=android")!) == false)
        #expect(screen.isTrustedCanvasUIURL(URL(string: "https://node.ts.net:18789/__remoteclaw__/canvas/")!) == false)
        #expect(screen.isTrustedCanvasUIURL(URL(string: "https://evil.ts.net:18789/__remoteclaw__/a2ui/?platform=ios")!) == false)
    ...
    @Test @MainActor func genericNavigationClearsTrustedRemoteA2UIURL() {
        let screen = ScreenController()
        screen.navigate(to: "https://node.ts.net:18789/__remoteclaw__/a2ui/?platform=ios", trustA2UIActions: true)
        screen.navigate(to: "https://evil.ts.net:18789/")

        #expect(screen.isTrustedCanvasUIURL(URL(string: "https://node.ts.net:18789/__remoteclaw__/a2ui/?platform=ios")!) == false)
    }
