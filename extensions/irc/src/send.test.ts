...
vi.mock("remoteclaw/plugin-sdk/plugin-config-runtime", async () => {
  const original = (await vi.importActual("remoteclaw/plugin-sdk/plugin-config-runtime")) as Record<
    string,
    unknown
  >;
  return {
...
vi.mock("remoteclaw/plugin-sdk/text-runtime", async () => {
  const original = (await vi.importActual("remoteclaw/plugin-sdk/text-runtime")) as Record<
    string,
    unknown
  >;
  return {
