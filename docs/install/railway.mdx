...
Deploy RemoteClaw on Railway with a one-click template and finish setup in your browser.
...
- `REMOTECLAW_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your RemoteClaw state + workspace so you can migrate to another host without losing config or memory.
