...
import ai.remoteclaw.android.ui.mobileSurface
import ai.remoteclaw.android.ui.mobileText
import ai.remoteclaw.android.ui.mobileTextSecondary
import ai.remoteclaw.android.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.remoteclaw.android.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.remoteclaw.android.ui.mobileFontFamily,
