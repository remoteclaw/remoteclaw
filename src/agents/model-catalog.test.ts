...
describe("loadModelCatalog", () => {
  ...
  // Tests for merging configured opt-in provider models, rejecting non-opted-in
  // providers, and deduplication have been removed because readConfiguredOptInProviderModels
  // is now a no-op (config.models.providers was gutted).
});
