...
You can point RemoteClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or RemoteClaw
...
- [Anthropic provider](/providers/anthropic) - Native RemoteClaw integration with Claude setup-token or API keys
