...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/remoteclaw-matrix-create-client-test",
    storagePath: "/tmp/remoteclaw-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/remoteclaw-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/remoteclaw-matrix-create-client-test/idb.snapshot",
    metaPath: "/tmp/remoteclaw-matrix-create-client-test/storage-meta.json",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "remoteclaw-matrix-default-token-hash",
