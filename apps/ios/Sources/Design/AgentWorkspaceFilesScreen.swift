            ...
            VStack(alignment: .leading, spacing: 0) {
                if let headerLeadingAction {
                    RemoteClawAdaptiveHeaderRow(
                        ...
                        titleFont: RemoteClawType.title3SemiBold,
        ...
        return NavigationLink {
            ...
            HStack(spacing: 12) {
                Image(systemName: isDirectory ? "folder" : "doc.text")
                    ...
                    .foregroundStyle(isDirectory ? RemoteClawBrand.accent : Color.secondary)
                    .frame(width: 24)
...
struct AgentWorkspaceFilePreview: View {
        ...
        if let file {
            ...
            VStack(spacing: 8) {
                Image(systemName: "doc.questionmark")
                    .font(RemoteClawType.title3SemiBold)
                    .foregroundStyle(.secondary)
                Text(errorText)
                    .font(RemoteClawType.footnote)
                    .foregroundStyle(.secondary)
            ...
            .padding(RemoteClawProMetric.pagePadding)
        }
    }
    ...
    private func share() {
        ...
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("RemoteClawWorkspaceFiles", isDirectory: true)
