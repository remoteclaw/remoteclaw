...
public enum RemoteClawChatCommandFilter: String, CaseIterable, Sendable {
    case all = "All"
    case commands = "Commands"
    case skills = "Skills"
}

public struct RemoteClawChatCommandChoice: Identifiable, Hashable, Sendable {
...
public struct RemoteClawChatMessage: Codable, Hashable, Identifiable, Sendable {
    private struct RemoteClawMetadata: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        let decodedRemoteClaw = try container.decodeIfPresent(RemoteClawMetadata.self, forKey: .remoteClaw)
        let decodedIdempotencyKey = try decodedRemoteClaw?.idempotencyKey ??
        ...
        let decodedUsage = try container.decodeIfPresent(RemoteClawChatUsage.self, forKey: .usage)
        ...
        let decodedContent: [RemoteClawChatMessageContent] = if let decoded = try? container.decode(
            [RemoteClawChatMessageContent].self,
            forKey: .content)
        {
            decoded
        ...
        let audioAttachments: [RemoteClawChatMessageContent] = alreadyContainsAudio ? [] : mediaPaths
            .enumerated()
...
public struct RemoteClawChatInFlightRun: Codable, Sendable {
...
public struct RemoteClawChatSessionInfo: Codable, Sendable {
...
public struct RemoteClawChatHistoryPayload: Codable, Sendable {
    ...
    public let sessionInfo: RemoteClawChatSessionInfo?
    public let inFlightRun: RemoteClawChatInFlightRun?
    ...
    public init(
        ...
        sessionInfo: RemoteClawChatSessionInfo? = nil,
        inFlightRun: RemoteClawChatInFlightRun? = nil)
    {
...
public struct RemoteClawChatCreateSessionResponse: Codable, Sendable {
    public let ok: Bool?
    public let key: String
    public let sessionId: String?
}
...
public struct RemoteClawSessionMessageEventPayload: Codable, Sendable {
    public let sessionKey: String?
    public let agentId: String?
    public let message: RemoteClawChatMessage?
