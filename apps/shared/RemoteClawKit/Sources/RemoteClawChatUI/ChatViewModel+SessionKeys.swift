...
extension RemoteClawChatViewModel {
    nonisolated static func chatContextUsageFraction(for session: RemoteClawChatSessionEntry?) -> Double? {
    ...
    public var sessionChoices: [RemoteClawChatSessionEntry] {
        ...
        let sorted = RemoteClawChatSessionListOrganizer.organize(sessions)
