...
function recoveryHintForGatewayHealthFailure(
  ...
  switch (classification) {
    case "auth-mismatch":
      return "Fix: run `remoteclaw doctor --fix`.";
    case "module-missing":
      return "Fix: run `remoteclaw doctor --fix`.";
    case "service-missing":
      return "Fix: run `remoteclaw gateway install --force`.";
    case "service-stopped":
      return "Fix: run `remoteclaw gateway restart`.";
    case "startup-blocked":
      return "Fix: run `remoteclaw gateway status --deep`.";
    case "not-listening":
      return "Fix: start `remoteclaw gateway run`, or run `remoteclaw gateway restart` for a managed gateway.";
    default:
      return undefined;
  }
}
