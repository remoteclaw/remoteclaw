...
export const FIELD_HELP: Record<string, string> = {
  ...
  "agents.defaults.agentRuntime":
    "Default agent runtime policy. Omitted id uses built-in RemoteClaw Pi. Use id=auto for plugin harness selection, a registered harness id such as codex, or a supported CLI backend alias such as claude-cli.",
  ...
  "agents.defaults.embeddedHarness":
    "Legacy input for agents.defaults.agentRuntime. Run remoteclaw doctor --fix to rewrite it to agentRuntime.",
  ...
  "agents.list.*.embeddedHarness":
    "Legacy input for agents.list.*.agentRuntime. Run remoteclaw doctor --fix to rewrite it to agentRuntime.",
  ...
  "session.parentForkMaxTokens":
    "Maximum parent-session token count allowed for thread/session inheritance forking. If the parent exceeds this, RemoteClaw starts a fresh thread session instead of forking; set 0 to disable this protection.",
  "session.mainKey":
