...
try {
  budgets = {
    publicEntrypoints: readBudgetEnv("REMOTECLAW_PLUGIN_SDK_MAX_PUBLIC_ENTRYPOINTS", 320),
    publicExports: readBudgetEnv("REMOTECLAW_PLUGIN_SDK_MAX_PUBLIC_EXPORTS", 10301),
    publicFunctionExports: readBudgetEnv("REMOTECLAW_PLUGIN_SDK_MAX_PUBLIC_FUNCTION_EXPORTS", 5171),
    publicDeprecatedExports: readBudgetEnv(
      "REMOTECLAW_PLUGIN_SDK_MAX_PUBLIC_DEPRECATED_EXPORTS",
      3244,
    ),
    publicWildcardReexports: readBudgetEnv(
      "REMOTECLAW_PLUGIN_SDK_MAX_PUBLIC_WILDCARD_REEXPORTS",
      215,
    ),
  };
  publicDeprecatedExportsByEntrypointBudget = readEntrypointBudgetEnv(
    "REMOTECLAW_PLUGIN_SDK_MAX_PUBLIC_DEPRECATED_EXPORTS_BY_ENTRYPOINT",
