...
RemoteClaw policy supports global requirements and stricter requirements for
...
The overlay model separates where policy is authored from where RemoteClaw config
is observed:
