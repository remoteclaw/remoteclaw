...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof RemoteClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: RemoteClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: RemoteClawConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
