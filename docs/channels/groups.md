...
For group/channel rooms, RemoteClaw defaults to `messages.groupChat.visibleReplies: "message_tool"`.
`remoteclaw doctor --fix` writes this default into configured-channel configs that omit it.
