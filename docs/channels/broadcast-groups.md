...
**Result:** When RemoteClaw would reply in this chat, it will run all three agents.
...
```bash
tail -f ~/.remoteclaw/logs/gateway.log | grep broadcast
```
