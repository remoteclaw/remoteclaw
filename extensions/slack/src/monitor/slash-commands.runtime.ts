...
} from "remoteclaw/plugin-sdk/command-auth-native";

type BuildCommandTextFromArgs =
  typeof import("remoteclaw/plugin-sdk/command-auth-native").buildCommandTextFromArgs;
type FindCommandByNativeName =
  typeof import("remoteclaw/plugin-sdk/command-auth-native").findCommandByNativeName;
type ListNativeCommandSpecsForConfig =
  typeof import("remoteclaw/plugin-sdk/command-auth-native").listNativeCommandSpecsForConfig;
type ParseCommandArgs = typeof import("remoteclaw/plugin-sdk/command-auth-native").parseCommandArgs;
type ResolveCommandArgMenu =
  typeof import("remoteclaw/plugin-sdk/command-auth-native").resolveCommandArgMenu;
