...
struct OnboardingWizardView: View {
        ...
        if self.focusedField != nil {
            ...
            .overlay {
                Capsule(style: .continuous)
                    .stroke(RemoteClawBrand.activationNeutralStroke, lineWidth: 0.6)
            }
    ...
    private var modeStep: some View {
        ...
        Section {
            ...
            .buttonStyle(RemoteClawPrimaryActionButtonStyle(height: 48, cornerRadius: 16))
        ...
        Group {
            Section {
                ...
                if let problem = self.currentProblem {
                    ...
                    Text("RemoteClaw is checking gateway and node access.")
                        .font(RemoteClawType.footnote)
                        .foregroundStyle(.secondary)
                }
            } header: {
