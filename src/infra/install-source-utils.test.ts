  ...
  it.each([
    {
      ...
      path: async () => "/tmp/does-not-exist-remoteclaw-archive.tgz",
...
describe("packNpmSpecToArchive", () => {
  ...
  it.each([
    ...
    },
    {
      ...
      stdout:
        'npm notice using cache\n[{"id":"remoteclaw-plugin@1.2.3","name":"remoteclaw-plugin","version":"1.2.3","integrity":"sha512-test-integrity","shasum":"abc123"}]\n',
      expectedMetadata: {
        name: "remoteclaw-plugin",
        version: "1.2.3",
        resolvedSpec: "remoteclaw-plugin@1.2.3",
