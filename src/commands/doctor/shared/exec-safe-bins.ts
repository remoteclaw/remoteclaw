...
export function scanExecSafeBinCoverage(cfg: RemoteClawConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: RemoteClawConfig): {
