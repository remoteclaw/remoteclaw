...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  ...
  "extensions/matrix/runtime-api.ts": [
    ...
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext, RemoteClawConfig, PluginRuntime, RuntimeLogger, RuntimeEnv, WizardPrompter } from "remoteclaw/plugin-sdk/matrix";',
