...
export async function promptGatewayConfig(
    ...
    if (tokenInputMode === "ref") {
      ...
      gatewayToken = {
        ...
        provider: resolveDefaultSecretProviderAlias(
          cfg as Parameters<typeof resolveDefaultSecretProviderAlias>[0],
          "env",
          {
  ...
  if (authMode === "trusted-proxy") {
    note(
      [
        "Trusted proxy mode: RemoteClaw trusts user identity from a reverse proxy.",
        ...
        "Docs: https://docs.remoteclaw.org/gateway/trusted-proxy-auth",
      ].join("\n"),
      "Trusted Proxy Auth",
    );
