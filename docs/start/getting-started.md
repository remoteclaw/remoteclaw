---
summary: "Get RemoteClaw installed and run your first chat in minutes."
read_when:
...
<Tooltip headline="Gateway host" tip="The machine running the RemoteClaw gateway service.">gateway host</Tooltip>.
...
<Steps>
  <Step title="Install RemoteClaw (recommended)">
    <Tabs>
