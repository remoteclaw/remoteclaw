...
final class CanvasWindowController: NSWindowController, WKNavigationDelegate, NSWindowDelegate {
    ...
    init(sessionKey: String, root: URL, presentation: CanvasPresentation) throws {
        ...
        (() => {
          try {
            ...
            if (globalThis.__remoteclawA2UIBridgeInstalled) return;
            globalThis.__remoteclawA2UIBridgeInstalled = true;
            ...
            globalThis.addEventListener('a2uiaction', (evt) => {
              try {
                ...
                const handler = globalThis.webkit?.messageHandlers?.remoteclawCanvasA2UIAction;
                ...
                const hasBundledA2UIHost =
                  !!globalThis.remoteclawA2UI ||
                  !!document.querySelector('remoteclaw-a2ui-host');
                ...
                location.href = 'remoteclaw://agent?' + params.toString();
              } catch {}
            }, true);
          } catch {}
        })();
    ...
    func snapshot(to outPath: String?) async throws -> String {
        ...
        if let outPath, !outPath.isEmpty {
            ...
            path = "/tmp/remoteclaw-canvas-\(CanvasWindowController.sanitizeSessionKey(self.sessionKey))-\(ts).png"
        }
