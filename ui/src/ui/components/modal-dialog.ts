...
export class RemoteClawModalDialog extends LitElement {
  @property() label = "";
  ...
  override render() {
    const labelId = this.label ? "remoteclaw-modal-dialog-label" : "";
    const descriptionId = this.description ? "remoteclaw-modal-dialog-description" : "";
    return html`
      <dialog
        role="dialog"
        aria-modal="true"
...
if (!customElements.get("remoteclaw-modal-dialog")) {
  customElements.define("remoteclaw-modal-dialog", RemoteClawModalDialog);
}

declare global {
  interface HTMLElementTagNameMap {
    "remoteclaw-modal-dialog": RemoteClawModalDialog;
  }
}
