...
Enable a specific hook by adding it to your config (`~/.remoteclaw/remoteclaw.json` by default).
...
- `remoteclaw hooks list --json`, `info --json`, and `check --json` write structured JSON directly to stdout.
