import { resolveMarkdownTableMode as resolveMarkdownTableModeImpl } from "remoteclaw/plugin-sdk/config-runtime";
import {
...
import { resolveAgentRoute as resolveAgentRouteImpl } from "remoteclaw/plugin-sdk/routing";
import { deliverSlackSlashReplies as deliverSlackSlashRepliesImpl } from "./replies.js";

type ResolveChunkMode = typeof import("remoteclaw/plugin-sdk/reply-runtime").resolveChunkMode;
type FinalizeInboundContext =
  typeof import("remoteclaw/plugin-sdk/reply-runtime").finalizeInboundContext;
...
type ResolveMarkdownTableMode =
  typeof import("remoteclaw/plugin-sdk/config-runtime").resolveMarkdownTableMode;
type ResolveAgentRoute = typeof import("remoteclaw/plugin-sdk/routing").resolveAgentRoute;
