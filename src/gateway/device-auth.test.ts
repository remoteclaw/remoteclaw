...
describe("device-auth payload vectors", () => {
  it.each([
    ...
    },
    {
      ...
      expected:
        "v3|dev-1|remoteclaw-macos|ui|operator|operator.admin,operator.read|1700000000000|tok-123|nonce-abc|ios|iphone",
    },
    {
      ...
      expected: "v3|dev-2|remoteclaw-ios|ui|operator|operator.read|1700000000001||nonce-def||",
    },
  ])("$name", ({ build, expected }) => {
