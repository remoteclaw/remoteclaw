/** Resolves ACP request metadata into RemoteClaw Gateway session keys and reset behavior. */
import { readBool, readString } from "@remoteclaw/acp-core/meta";
import type { AcpServerOptions } from "@remoteclaw/acp-core/types";
...
/** Parses ACP request metadata into RemoteClaw session routing hints. */
