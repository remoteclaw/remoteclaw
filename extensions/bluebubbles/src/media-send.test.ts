...
import type { RemoteClawConfig, PluginRuntime } from "remoteclaw/plugin-sdk/bluebubbles";
...
function createConfig(overrides?: Record<string, unknown>): RemoteClawConfig {
  return {
    channels: {
      bluebubbles: {
        ...overrides,
