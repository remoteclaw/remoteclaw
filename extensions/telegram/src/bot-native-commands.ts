...
export const registerTelegramNativeCommands = ({
  ...
  const loadFreshRuntimeConfig = (): RemoteClawConfig => telegramDeps.loadConfig();
  const resolveFreshTelegramConfig = (runtimeCfg: RemoteClawConfig): TelegramAccountConfig => {
    try {
