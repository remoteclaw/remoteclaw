...
remoteclaw voicecall smoke    [-t <phone>] [--message <text>] [--mode <m>] [--yes] [--json]
remoteclaw voicecall call     -m <text> [-t <phone>] [--mode <m>]
remoteclaw voicecall start    --to <phone> [--message <text>] [--mode <m>]
remoteclaw voicecall continue --call-id <id> --message <text>
remoteclaw voicecall speak    --call-id <id> --message <text>
remoteclaw voicecall dtmf     --call-id <id> --digits <digits>
remoteclaw voicecall end      --call-id <id>
remoteclaw voicecall status   [--call-id <id>] [--json]
remoteclaw voicecall tail     [--file <path>] [--since <n>] [--poll <ms>]
remoteclaw voicecall latency  [--file <path>] [--last <n>]
remoteclaw voicecall expose   [--mode <m>] [--path <p>] [--port <port>] [--serve-path <p>]
```
...
| `--message <text>` | `RemoteClaw voice call smoke test.` | Message to speak during the smoke call. |
...
```bash
remoteclaw voicecall call --to "+15555550123" --message "Hello"
remoteclaw voicecall call -m "Heads up" --mode notify
```
...
```bash
remoteclaw voicecall status
remoteclaw voicecall status --json
