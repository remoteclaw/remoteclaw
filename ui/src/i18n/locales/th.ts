...
export const th: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      qrAlt: "คิวอาร์โค้ดสำหรับจับคู่ RemoteClaw mobile",
      ...
      review: "ตรวจทาน",
      waiting: "แอป RemoteClaw mobile อย่างเป็นทางการจะเชื่อมต่อโดยอัตโนมัติหลังจากสแกน",
  ...
  worktrees: {
    ...
    subtitle: "การ checkout คลังแยกที่เป็นของ RemoteClaw",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "ใช้งานบนมือถืออยู่หรือไม่? คัดลอก URL แบบเต็ม (รวม #token=...) จาก remoteclaw dashboard --no-open บนเดสก์ท็อปของคุณ",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — ยืนยันตัวตนใหม่ด้วย remoteclaw models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "วางโทเค็นจาก remoteclaw dashboard --no-open หรือป้อนรหัสผ่านที่ตั้งค่าไว้",
        stepGenerate:
          "ถ้ายังไม่ได้ตั้งค่าโทเค็น ให้รัน remoteclaw doctor --generate-gateway-token บนโฮสต์ Gateway",
      ...
      authFailed: {
        ...
        stepDashboard: "รัน remoteclaw dashboard --no-open แล้วเปิด URL ใหม่หรือวางโทเค็นของ URL นั้น",
      ...
      pairing: {
        ...
        stepList: "รัน remoteclaw devices list บนโฮสต์ Gateway",
        stepApproveId: "อนุมัติคำขอนี้: remoteclaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "เปิด dashboard ที่เสิร์ฟอีกครั้งด้วย remoteclaw dashboard เพื่อให้ UI และ Gateway มาจากการติดตั้งเดียวกัน",
        stepDevUi: "ถ้าใช้ pnpm ui:dev ให้ build ใหม่หรือรีสตาร์ท UI dev กับ checkout ปัจจุบัน",
        stepRestart: "รีสตาร์ท Gateway หลังอัปเดต RemoteClaw เพื่อให้เสิร์ฟโปรโตคอลปัจจุบัน",
      },
      network: {
        title: "เชื่อมต่อไม่ได้",
        summary:
          "เบราว์เซอร์ไม่สามารถเชื่อมต่อ Gateway ให้เสร็จสมบูรณ์ได้ ตรวจสอบเป้าหมายและ transport ก่อนลองข้อมูลรับรองอีกครั้ง",
        stepGateway: "ยืนยันว่า Gateway กำลังทำงานด้วย remoteclaw status หรือ remoteclaw gateway run",
        stepUrl: "ตรวจสอบ WebSocket URL และใช้ wss:// เมื่อ Gateway อยู่หลัง HTTPS/Tailscale Serve",
        stepDashboard:
          "เปิด dashboard อีกครั้งด้วย remoteclaw dashboard --no-open เพื่อคัดลอก URL และรายละเอียด auth ปัจจุบันใหม่",
      },
    },
  },
  connection: {
