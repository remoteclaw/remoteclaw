...
// STRIPPED (not in fork):   resolveNativeSkillsEnabled,
...
// STRIPPED: export { applyModelOverrideToSessionEntry } from "../sessions/model-overrides.js";
...
// STRIPPED (not in fork):   TelegramExecApprovalConfig,
  TelegramGroupConfig,
