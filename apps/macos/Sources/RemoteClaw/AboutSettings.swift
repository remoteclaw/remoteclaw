...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/remoteclaw/remoteclaw") {
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "RemoteClawBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "RemoteClawBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "RemoteClawGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "RemoteClawGitCommit") as? String) ??
            "unknown"
    }
