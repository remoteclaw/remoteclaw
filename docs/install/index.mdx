...
Move to a new machine.
  ...
  <Card title="From RemoteClaw">

[From RemoteClaw](/install/from-remoteclaw) —
Migrate an RemoteClaw installation to RemoteClaw.

  </Card>
  <Card title="Breaking changes">

[Breaking changes](/install/breaking-changes-from-remoteclaw) —
What changed from RemoteClaw.
