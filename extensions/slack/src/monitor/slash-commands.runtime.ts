...
type BuildCommandTextFromArgs =
  typeof import("remoteclaw/plugin-sdk/command-auth").buildCommandTextFromArgs;
type FindCommandByNativeName =
  typeof import("remoteclaw/plugin-sdk/command-auth").findCommandByNativeName;
type ListNativeCommandSpecsForConfig =
  typeof import("remoteclaw/plugin-sdk/command-auth").listNativeCommandSpecsForConfig;
type ParseCommandArgs = typeof import("remoteclaw/plugin-sdk/command-auth").parseCommandArgs;
type ResolveCommandArgMenu =
  typeof import("remoteclaw/plugin-sdk/command-auth").resolveCommandArgMenu;
