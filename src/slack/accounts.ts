...
function mergeSlackAccountConfig(cfg: RemoteClawConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: RemoteClawConfig): ResolvedSlackAccount[] {
