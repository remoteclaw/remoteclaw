...
describe("toSanitizedMarkdownHtml", () => {
  ...
  describe("explicit protocol links", () => {
    ...
    it("links http:// URLs", () => {
      const html = toSanitizedMarkdownHtml("Visit http://github.com/remoteclaw");
      expect(html).toContain('<a href="http://github.com/remoteclaw"');
    });
    ...
    it("does NOT rewrite explicit markdown links with CJK display text", () => {
      const html = toSanitizedMarkdownHtml("[RemoteClaw中文](https://docs.remoteclaw.org)");
      expect(html).toContain('href="https://docs.remoteclaw.org"');
      expect(html).toContain("RemoteClaw中文</a>");
    });
