...
Files in `apps/macos/Sources/RemoteClaw/Resources/DeviceModels/`:
...
2. Update `apps/macos/Sources/RemoteClaw/Resources/DeviceModels/NOTICE.md` with the new SHAs.
