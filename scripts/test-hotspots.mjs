import { formatMs, loadVitestReportFromArgs, parseVitestReportArgs } from "./lib/vitest-report-cli-utils.mjs";
...
const report = loadVitestReportFromArgs(opts, "remoteclaw-vitest-hotspots");
const fileResults = collectVitestFileDurations(report).toSorted((a, b) => b.durationMs - a.durationMs);
