/**
 * Persistent lease store for ACPX wrapper processes. Leases let RemoteClaw attach
...
} from "remoteclaw/plugin-sdk/plugin-state-runtime";
...
export const REMOTECLAW_ACPX_LEASE_ID_ENV = "REMOTECLAW_ACPX_LEASE_ID";
/** Environment variable carrying the owning gateway instance id. */
export const REMOTECLAW_GATEWAY_INSTANCE_ID_ENV = "REMOTECLAW_GATEWAY_INSTANCE_ID";
/** CLI argument carrying the ACPX process lease id for platforms without env wrapping. */
export const REMOTECLAW_ACPX_LEASE_ID_ARG = "--remoteclaw-acpx-lease-id";
/** CLI argument carrying the owning gateway instance id. */
export const REMOTECLAW_GATEWAY_INSTANCE_ID_ARG = "--remoteclaw-gateway-instance-id";
