...
import SHARED_TOOL_DISPLAY_JSON from "../../../../apps/shared/RemoteClawKit/Sources/RemoteClawKit/Resources/tool-display.json" with { type: "json" };
import {
  defaultTitle,
...
type ChatToolIconName = IconName;
...
export function resolveToolDisplay(params: {
  ...
  const icon = (spec?.icon ?? FALLBACK.icon ?? "puzzle") as ChatToolIconName;
