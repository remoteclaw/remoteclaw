...
describe("workspace bootstrap file caching", () => {
  ...
  beforeEach(async () => {
    workspaceDir = await makeTempWorkspace("remoteclaw-bootstrap-cache-test-");
  });
  ...
  it("caches files independently by path", async () => {
    ...
    const workspace1 = await makeTempWorkspace("remoteclaw-cache-test1-");
    const workspace2 = await makeTempWorkspace("remoteclaw-cache-test2-");
