...
RemoteClaw iOS is the officially released iPhone app. It connects to an RemoteClaw Gateway as a `role: node` for chat, voice, approvals, sharing, and device-aware automation.
