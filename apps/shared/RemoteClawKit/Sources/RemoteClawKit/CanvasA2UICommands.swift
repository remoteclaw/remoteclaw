...
public enum RemoteClawCanvasA2UICommand: String, Codable, Sendable {
...
public struct RemoteClawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct RemoteClawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
