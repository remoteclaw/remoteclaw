...
${formatHelpExamples([
  ...
  [
    "openclaw agents set-identity --workspace ~/.remoteclaw/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "openclaw agents set-identity --identity-file ~/.remoteclaw/workspace/IDENTITY.md --agent main",
