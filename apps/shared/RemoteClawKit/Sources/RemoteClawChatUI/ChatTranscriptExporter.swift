...
public enum ChatTranscriptExporter {
    ...
    public static func markdown(
        sessionTitle: String?,
        sessionKey: String,
        messages: [RemoteClawChatMessage]) -> String
    {
    ...
    private static func shouldExport(_ message: RemoteClawChatMessage) -> Bool {
    ...
    private static func body(for message: RemoteClawChatMessage) -> String {
        var parts: [String] = []
        let text = self.visibleText(in: message)
        if !text.isEmpty {
            parts.append(text)
    ...
    private static func visibleText(in message: RemoteClawChatMessage) -> String {
        ChatMessageVisibleText.visibleText(in: message)
    }

    private static func attachments(in message: RemoteClawChatMessage) -> [RemoteClawChatMessageContent] {
