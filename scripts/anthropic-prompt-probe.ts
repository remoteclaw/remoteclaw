// Anthropic Prompt Probe script supports RemoteClaw repository automation.
...
const KEEP_TMP = parseBooleanEnv({
  fallback: false,
  name: "REMOTECLAW_PROMPT_KEEP_TMP",
  raw: process.env.REMOTECLAW_PROMPT_KEEP_TMP,
});
...
const CAPTURE_PROXY_MAX_BODY_BYTES = parseStrictIntegerOption({
  ...
  label: "REMOTECLAW_PROMPT_CAPTURE_MAX_BODY_BYTES",
  min: 1,
  raw: process.env.REMOTECLAW_PROMPT_CAPTURE_MAX_BODY_BYTES,
});
