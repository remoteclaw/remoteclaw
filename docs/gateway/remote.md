...
<Note>
Replace `18789` with your configured `gateway.port` (or `--port` or `REMOTECLAW_GATEWAY_PORT`).
</Note>
...
<Note>
If you have a leftover `com.remoteclaw.ssh-tunnel` LaunchAgent from an older setup, unload and delete it.
</Note>
