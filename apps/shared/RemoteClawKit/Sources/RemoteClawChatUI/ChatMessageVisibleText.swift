...
enum ChatMessageVisibleText {
    static func visibleText(in message: RemoteClawChatMessage) -> String {
    ...
    static func hasVisibleText(in message: RemoteClawChatMessage) -> Bool {
        !self.visibleText(in: message)
            .trimmingCharacters(in: .whitespacesAndNewlines)
            .isEmpty
    }

    private static func primaryText(in message: RemoteClawChatMessage) -> String {
