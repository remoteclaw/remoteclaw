...
<AccordionGroup>
  ...
  <Accordion title="Config, update, and wizard">
  ...
  <Accordion title="Approval families">
    - `exec.approval.request` and `exec.approval.resolve` cover one-shot exec approval requests and resolution.
  ...
  <Accordion title="Automation, skills, and tools">
    ...
    - Skills and tools: `skills.*`, `tools.catalog`, `tools.effective`.
  </Accordion>
</AccordionGroup>
