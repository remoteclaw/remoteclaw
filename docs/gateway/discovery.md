...
- TXT keys (non-secret):
  ...
  - `cliPath=<path>` (optional; absolute path to a runnable `remoteclaw` entrypoint or binary)
...
- `REMOTECLAW_SSH_PORT` overrides the SSH port advertised in TXT (defaults to 22).
