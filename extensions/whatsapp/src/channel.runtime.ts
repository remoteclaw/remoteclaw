...
import { monitorWebChannel as monitorWebChannelImpl } from "remoteclaw/plugin-sdk/whatsapp";

type MonitorWebChannel = typeof import("remoteclaw/plugin-sdk/whatsapp").monitorWebChannel;
