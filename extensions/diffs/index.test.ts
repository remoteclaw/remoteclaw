...
import type { RemoteClawPluginApi } from "remoteclaw/plugin-sdk/diffs";
...
describe("diffs plugin registration", () => {
  ...
  it("applies plugin-config defaults through registered tool and viewer handler", async () => {
    ...
    type RegisteredHttpRouteParams = Parameters<RemoteClawPluginApi["registerHttpRoute"]>[0];
    ...
    const api = createTestPluginApi({
      ...
      runtime: {} as never,
      registerTool(tool: Parameters<RemoteClawPluginApi["registerTool"]>[0]) {
