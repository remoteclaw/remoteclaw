...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.remoteclaw.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("remoteclaw hooks list")}`,
      `  ${formatCliCommand("remoteclaw hooks enable <name>")}`,
      `  ${formatCliCommand("remoteclaw hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
