...
- Keep product names in English: RemoteClaw, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the RemoteClaw Gateway, use “Gateway 网关”.
