...
export const DEFAULT_SANDBOX_IMAGE = "remoteclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "remoteclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "remoteclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "remoteclaw-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "remoteclaw-sbx-browser-";
