...
import type { AnyAgentTool, RemoteClawPluginApi, PluginCommandContext } from "../plugins/types.js";
import { normalizeLowercaseStringOrEmpty } from "../shared/string-coerce.js";

export type { AnyAgentTool, RemoteClawPluginApi, PluginCommandContext };
...
type DefineBundledChannelEntryOptions<TPlugin = ChannelPlugin> = {
  ...
  registerCliMetadata?: (api: RemoteClawPluginApi) => void;
  registerFull?: (api: RemoteClawPluginApi) => void;
};
...
const disableBundledEntrySourceFallbackEnv = "REMOTECLAW_DISABLE_BUNDLED_ENTRY_SOURCE_FALLBACK";
