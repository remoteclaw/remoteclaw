...
import { connectDeviceAuthReq, connectGatewayClient, getFreeGatewayPort } from "./test-helpers.e2e.js";
...
describe("gateway e2e", () => {
  ...
  it("runs wizard over ws and writes auth token config", { timeout: GATEWAY_E2E_TIMEOUT_MS }, async () => {
    ...
    try {
      ...
      const token = (parsed as Record<string, unknown>)?.gateway as Record<string, unknown> | undefined;
