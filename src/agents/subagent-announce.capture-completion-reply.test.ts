...
// Skipped: depends on gutted captureSubagentCompletionReply function
describe.skip("captureSubagentCompletionReply", () => {
  let previousFastTestEnv: string | undefined;
  let captureSubagentCompletionReply: any;

  beforeAll(async () => {
    previousFastTestEnv = process.env.REMOTECLAW_TEST_FAST;
    process.env.REMOTECLAW_TEST_FAST = "1";
    ({ captureSubagentCompletionReply } = (await import("./subagent-announce.js")) as any);
  });
