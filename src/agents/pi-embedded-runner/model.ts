...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveRemoteClawAgentDir();
...
const LOCAL_PROVIDER_HINTS: Record<string, string> = {
  ollama:
    ...
    'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "remoteclaw configure". ' +
    "See: https://docs.remoteclaw.ai/providers/ollama",
  vllm:
    "vLLM requires authentication to be registered as a provider. " +
    'Set VLLM_API_KEY (any value works) or run "remoteclaw configure". ' +
    "See: https://docs.remoteclaw.ai/providers/vllm",
};
