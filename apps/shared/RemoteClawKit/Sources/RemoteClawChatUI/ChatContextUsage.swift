...
public struct RemoteClawChatContextUsage: Equatable, Sendable {
...
enum ChatContextUsageCalculator {
    ...
    static func usage(
        ...
        sessionEntry: RemoteClawChatSessionEntry?,
        defaults: RemoteClawChatSessionsDefaults?,
        modelContextWindow: Int?) -> RemoteClawChatContextUsage?
    {
        ...
        return RemoteClawChatContextUsage(
    ...
    private static func latestRunTokens(in messages: [RemoteClawChatMessage]) -> Int? {
    ...
    private static func totalCost(in messages: [RemoteClawChatMessage]) -> Double? {
...
extension RemoteClawChatViewModel {
    public var contextUsage: RemoteClawChatContextUsage? {
    ...
    private func selectedModelContextWindow(sessionEntry: RemoteClawChatSessionEntry?) -> Int? {
