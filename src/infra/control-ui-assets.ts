...
import { resolveRemoteClawPackageRoot, resolveRemoteClawPackageRootSync } from "./openclaw-root.js";
...
export async function resolveControlUiDistIndexPath(
  ...
  const packageRoot = await resolveRemoteClawPackageRoot({ argv1: normalized, moduleUrl });
  if (packageRoot) {
