...
function resolveDefaultAccountId(cfg: RemoteClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: RemoteClawConfig): boolean {
...
export function summarizeBindings(cfg: RemoteClawConfig, bindings: AgentBinding[]): string[] {
