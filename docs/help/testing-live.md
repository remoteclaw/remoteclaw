...
- How to select models:
  ...
  - or `REMOTECLAW_LIVE_MODELS="openai/gpt-5.2,openai-codex/gpt-5.2,anthropic/claude-opus-4-6,..."` (comma allowlist)
...
- Overrides (optional):
  - `REMOTECLAW_LIVE_CLI_BACKEND_MODEL="codex-cli/gpt-5.2"`
...
- Overrides:
  ...
  - `REMOTECLAW_LIVE_ACP_BIND_CODEX_MODEL=gpt-5.2`
  ...
  - `REMOTECLAW_LIVE_ACP_BIND_PARENT_MODEL=openai/gpt-5.2`
- Notes:
...
REMOTECLAW_LIVE_CODEX_HARNESS=1 \
  ...
  REMOTECLAW_LIVE_CODEX_HARNESS_MODEL=openai/gpt-5.2 \
...
- Tool calling across several providers:
  - `REMOTECLAW_LIVE_GATEWAY_MODELS="openai/gpt-5.2,openai-codex/gpt-5.2,anthropic/claude-opus-4-6,google/gemini-3-flash-preview,deepseek/deepseek-v4-flash,zai/glm-5.1,minimax/MiniMax-M2.7" pnpm test:live src/gateway/gateway-models.profiles.live.test.ts`
...
`REMOTECLAW_LIVE_GATEWAY_MODELS="openai/gpt-5.2,openai-codex/gpt-5.2,anthropic/claude-opus-4-6,google/gemini-3.1-pro-preview,google/gemini-3-flash-preview,google-antigravity/claude-opus-4-6-thinking,google-antigravity/gemini-3-flash,deepseek/deepseek-v4-flash,zai/glm-5.1,minimax/MiniMax-M2.7" pnpm test:live src/gateway/gateway-models.profiles.live.test.ts`
...
- Optional narrowing:
  - `REMOTECLAW_LIVE_VIDEO_GENERATION_PROVIDERS="google,openai,runway"`
