...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.media.audio.maxBytes": "Audio Max Bytes",
  "tools.media.audio.maxChars": "Audio Max Chars",
  "tools.media.audio.prompt": "Audio Transcription Prompt",
  ...
  "skills.load.watch": "Watch Skill Files",
  "skills.load.watchDebounceMs": "Skill Watch Debounce (ms)",
  ...
  "commands.allowFrom": "Command Access Rules",
  ui: "UI",
