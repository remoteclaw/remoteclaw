...
const DEFAULT_VAPID_SUBJECT = "mailto:remoteclaw@localhost";
...
function resolveVapidSubjectFromEnv(): string {
  return process.env.REMOTECLAW_VAPID_SUBJECT || DEFAULT_VAPID_SUBJECT;
}

function resolveVapidPublicKeyFromEnv(): string | undefined {
  return process.env.REMOTECLAW_VAPID_PUBLIC_KEY || undefined;
}

function resolveVapidPrivateKeyFromEnv(): string | undefined {
  return process.env.REMOTECLAW_VAPID_PRIVATE_KEY || undefined;
}
