...
2. On your Nextcloud server, create a bot:
   ...
   ```bash
   ./occ talk:bot:install "RemoteClaw" "<shared-secret>" "<webhook-url>" --feature webhook --feature response --feature reaction
   ```
...
4. Configure RemoteClaw:
   ...
   ```bash
   remoteclaw channels add --channel nextcloud-talk \
...
- Approve via:
  - `remoteclaw pairing list nextcloud-talk`
  - `remoteclaw pairing approve nextcloud-talk <CODE>`
