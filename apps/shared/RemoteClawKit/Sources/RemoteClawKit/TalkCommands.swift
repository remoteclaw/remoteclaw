...
public enum RemoteClawTalkCommand: String, Codable, Sendable {
...
public struct RemoteClawTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct RemoteClawTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
