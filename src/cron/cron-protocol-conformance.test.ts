...
const SWIFT_MODEL_CANDIDATES = ["apps/macos/Sources/RemoteClaw/CronModels.swift"];
const SWIFT_STATUS_CANDIDATES = ["apps/macos/Sources/RemoteClaw/GatewayConnection.swift"];
