...
final class ShareViewController: UIViewController {
    ...
    private let logger = Logger(subsystem: "ai.remoteclaw.ios", category: "ShareExtension")
    ...
    private func setupUI() {
        ...
        self.sendButton.setTitle("Send to RemoteClaw", for: .normal)
    ...
    private func sendCurrentDraft() async {
        ...
        self.showStatus("Sending to RemoteClaw gateway…")
        ...
        do {
            ...
            self.showStatus("Sent to RemoteClaw.")
    ...
    private func sendMessageToGateway(_ message: String, attachments: [ShareAttachment]) async throws {
        guard let config = ShareGatewayRelaySettings.loadConfig() else {
            throw NSError(
                ...
                code: 10,
                userInfo: [NSLocalizedDescriptionKey: "RemoteClaw is not connected to a gateway yet."])
        }
