...
export const uk: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      qrAlt: "QR-код сполучення RemoteClaw mobile",
      ...
      review: "Перегляд",
      waiting:
        "Офіційні мобільні застосунки RemoteClaw підключаються автоматично після сканування.",
  ...
  worktrees: {
    ...
    subtitle: "Ізольовані копії репозиторію, що належать RemoteClaw.",
  ...
  subtitles: {
    ...
    config: "Редагування remoteclaw.json.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "На мобільному? Скопіюйте повний URL (включно з #token=...) з remoteclaw dashboard --no-open на вашому комп’ютері.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — повторно виконайте авторизацію через remoteclaw models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Вставте токен з remoteclaw dashboard --no-open або введіть налаштований пароль.",
        stepGenerate:
          "Якщо токен не налаштовано, виконайте remoteclaw doctor --generate-gateway-token на хості Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Виконайте remoteclaw dashboard --no-open і відкрийте свіжий URL або вставте його токен.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Виконайте remoteclaw devices list на хості Gateway.",
        stepApproveId: "Схваліть цей запит: remoteclaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Знову відкрийте наданий dashboard через remoteclaw dashboard, щоб UI і Gateway походили з однієї інсталяції.",
        stepDevUi:
          "Якщо використовуєте pnpm ui:dev, перебудуйте або перезапустіть dev UI з поточного checkout.",
        stepRestart:
          "Перезапустіть Gateway після оновлення RemoteClaw, щоб він надавав поточний протокол.",
      },
      network: {
        ...
        stepGateway:
          "Підтвердьте, що Gateway працює, через remoteclaw status або remoteclaw gateway run.",
        stepUrl:
          "Перевірте WebSocket URL і використовуйте wss://, коли Gateway знаходиться за HTTPS/Tailscale Serve.",
        stepDashboard:
          "Знову відкрийте dashboard через remoteclaw dashboard --no-open, щоб повторно скопіювати поточний URL і деталі auth.",
      },
    },
  },
  connection: {
