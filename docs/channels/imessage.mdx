---
description: "Legacy iMessage support via imsg (JSON-RPC over stdio). New setups should use BlueBubbles."
read_when:
...
<CardGrid>
  <Card title="BlueBubbles (recommended)">

[BlueBubbles (recommended)](/channels/bluebubbles) —
...
[Configuration reference](/gateway/configuration-reference#imessage) —
...
<Tabs>
  <TabItem label="Local Mac (fast path)">
    <Steps>
...
4.  **Approve first DM pairing (default dmPolicy)**
  ...
  <TabItem label="Remote Mac over SSH">
...
<Tabs>
  ...
  <TabItem label="Group policy + mentions">
  ...
  <TabItem label="Sessions and deterministic replies">
...
## Deployment patterns
  ...
  <details>
<summary>Dedicated bot macOS user (separate iMessage identity)</summary>
  ...
  <details>
<summary>Remote Mac over Tailscale (example)</summary>
...
```
  ...
  <details>
<summary>Multi-account pattern</summary>
...
## Media, chunking, and delivery targets
  ...
  <details>
<summary>Attachments and media</summary>
  ...
  <details>
<summary>Outbound chunking</summary>
  ...
  <details>
<summary>Addressing formats</summary>
