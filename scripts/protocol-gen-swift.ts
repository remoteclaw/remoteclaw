...
const outPaths = [
  path.join(repoRoot, "apps", "macos", "Sources", "RemoteClawProtocol", "GatewayModels.swift"),
  path.join(repoRoot, "apps", "shared", "RemoteClawKit", "Sources", "RemoteClawProtocol", "GatewayModels.swift"),
];
