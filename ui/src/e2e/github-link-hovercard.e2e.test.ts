...
describeControlUiE2e("GitHub link hover cards", () => {
  ...
  it("previews issue and pull request links while preserving navigation", async () => {
          ...
          content: [
            {
              type: "text",
              text: [
                "Review [#99816](https://github.com/remoteclaw/remoteclaw/pull/99816),",
                "then [#99815](https://github.com/remoteclaw/remoteclaw/issues/99815).",
                "A [missing item](https://github.com/remoteclaw/remoteclaw/issues/999999) stays usable.",
                "The [repository](https://github.com/remoteclaw/remoteclaw) has no item preview.",
              ].join(" "),
            },
          ],
          role: "assistant",
    ...
    await expectText(card, "remoteclaw/remoteclaw #99816");
    ...
    expect(await missingLink.getAttribute("href")).toBe(
      "https://github.com/remoteclaw/remoteclaw/issues/999999",
    );
    await page.mouse.move(1, 1);
    ...
    expect(popup.url()).toBe("https://github.com/remoteclaw/remoteclaw/pull/99816");
  });
});
