// Resolves RemoteClaw home and platform-specific config directories.
...
/** Resolves RemoteClaw's effective home, honoring REMOTECLAW_HOME before OS homes. */
...
/** Resolves the underlying OS user home, ignoring REMOTECLAW_HOME overrides. */
...
export function resolveRequiredHomeDir(
  ...
  throw new Error(
    "Unable to resolve an RemoteClaw home: set REMOTECLAW_HOME, HOME, or USERPROFILE, or run from an existing directory.",
  );
}
...
/** Resolves a user-supplied path against the OS home, ignoring REMOTECLAW_HOME. */
