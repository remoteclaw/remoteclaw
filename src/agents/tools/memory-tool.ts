...
function resolveMemoryToolContext(options: { config?: RemoteClawConfig; agentSessionKey?: string }) {
...
async function getMemoryManagerContext(params: { cfg: RemoteClawConfig; agentId: string }): Promise<
  | {
...
function createMemoryTool(params: {
  ...
  execute: (ctx: { cfg: RemoteClawConfig; agentId: string }) => AnyAgentTool["execute"];
}): AnyAgentTool | null {
...
function resolveMemoryCitationsMode(cfg: RemoteClawConfig): MemoryCitationsMode {
