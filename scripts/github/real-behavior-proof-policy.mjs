...
const CLAWSWEEPER_BOT_LOGINS = new Set(["clawsweeper[bot]", "remoteclaw-clawsweeper[bot]"]);
...
const liveCommandRegex =
  /\b(?:remoteclaw|node|docker|curl|gh|ssh|adb|xcrun|xcodebuild|open|npm\s+run|pnpm\s+remoteclaw)\b/i;
