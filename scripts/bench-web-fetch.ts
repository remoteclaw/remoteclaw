...
const TEXT_BODY = "RemoteClaw web_fetch direct text benchmark body.".repeat(160);
...
const toolConfig: RemoteClawConfig = {
  tools: {
    web: {
      fetch: {
        cacheTtlMinutes: 0,
...
function printUsage(): void {
  process.stdout.write(`RemoteClaw web_fetch benchmark
