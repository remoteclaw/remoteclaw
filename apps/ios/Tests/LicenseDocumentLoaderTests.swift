...
struct LicenseDocumentLoaderTests {
    ...
    @Test func `derives readable titles from license filenames`() {
        ...
        #expect(LicenseDocumentLoader.title(from: "remoteclaw_plugin_sdk.txt") == "remoteclaw plugin sdk")
    ...
    private static func makeTemporaryDirectory() throws -> URL {
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("RemoteClawLicenseDocumentLoaderTests-\(UUID().uuidString)", isDirectory: true)
