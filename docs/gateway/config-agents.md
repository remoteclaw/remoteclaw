...
Most deployments should keep the default RemoteClaw Pi runtime.
...
- Environment overrides: `REMOTECLAW_AGENT_RUNTIME=<id|auto|pi>` overrides `runtime`; `REMOTECLAW_AGENT_HARNESS_FALLBACK=pi|none` overrides fallback for that process.
