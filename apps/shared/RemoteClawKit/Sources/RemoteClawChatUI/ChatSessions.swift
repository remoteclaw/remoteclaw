...
public struct RemoteClawChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct RemoteClawChatSessionsListResponse: Codable, Sendable {
    ...
    public let defaults: RemoteClawChatSessionsDefaults?
    public let sessions: [RemoteClawChatSessionEntry]
}
