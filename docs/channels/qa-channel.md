---
summary: "Synthetic Slack-class channel plugin for deterministic RemoteClaw QA scenarios"
title: "QA channel"
read_when:
...
```json
{
  "channels": {
    "qa-channel": {
      ...
      "botUserId": "remoteclaw",
      "botDisplayName": "RemoteClaw QA",
      "allowFrom": ["*"],
      "pollTimeoutMs": 1000
    }
  }
...
- `botUserId` - synthetic bot user id used in target grammar (default: `remoteclaw`).
- `botDisplayName` - display name for outbound messages (default: `RemoteClaw QA`).
