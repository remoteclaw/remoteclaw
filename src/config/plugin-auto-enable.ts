...
function isTelegramConfigured(cfg: RemoteClawConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: RemoteClawConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: RemoteClawConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: RemoteClawConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: RemoteClawConfig): boolean {
...
function isIMessageConfigured(cfg: RemoteClawConfig): boolean {
