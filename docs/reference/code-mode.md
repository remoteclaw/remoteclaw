...
This page documents RemoteClaw code mode. It is not Codex Code mode. Codex Code
...
dynamic tool search are stable Codex harness surfaces. RemoteClaw code mode is an
RemoteClaw-owned experimental tool-surface adapter for generic RemoteClaw runs. It
uses `quickjs-wasi`, a hidden RemoteClaw tool catalog, and the normal RemoteClaw
tool executor.
