...
- `--section <section>`: repeatable guided-setup section filter when you run `remoteclaw config` without a subcommand
...
1. Value mode: `remoteclaw config set <path> <value>`
