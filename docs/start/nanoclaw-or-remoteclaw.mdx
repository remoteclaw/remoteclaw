...
- **20+ messaging channels.** NanoClaw supports WhatsApp, Telegram, Slack, Discord, and Gmail. RemoteClaw inherits RemoteClaw's full adapter library.
...
| **Channels**        | 20+ (inherited from RemoteClaw)              | WhatsApp, Telegram, Slack, Discord, Gmail |
