...
function expectRemoteClawSchemaInvalidPreservesField(params: {
  config: unknown;
  ...
  const res = RemoteClawSchema.safeParse(params.config);
...
describe("legacy config detection", () => {
  ...
  it("rejects removed legacy provider sections", () => {
    expectRemoteClawSchemaInvalidPreservesField({
  ...
  it("preserves claude-cli auth profile mode during validation", () => {
    ...
    const res = RemoteClawSchema.safeParse(config);
