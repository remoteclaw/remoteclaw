---
description: "Use Qianfan's unified API to access many models in RemoteClaw"
read_when:
...
3. RemoteClaw installed on your system
...
4. Copy the API key for use with RemoteClaw

## CLI setup

```bash
remoteclaw onboard --auth-choice qianfan-api-key
```
