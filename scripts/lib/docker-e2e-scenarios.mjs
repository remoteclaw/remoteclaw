...
export const mainLanes = [
  ...
  serviceLane("openwebui", "REMOTECLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:openwebui", {
...
function openWebUILane() {
  return serviceLane("openwebui", "REMOTECLAW_SKIP_DOCKER_BUILD=1 pnpm test:docker:openwebui", {
    timeoutMs: OPENWEBUI_TIMEOUT_MS,
    weight: 5,
  });
}
