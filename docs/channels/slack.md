...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure RemoteClaw HTTP mode">
...
```json
{
  "display_information": {
    "name": "RemoteClaw",
    "description": "Slack connector for RemoteClaw"
  },
  "features": {
    "bot_user": {
      "display_name": "RemoteClaw",
      "always_online": false
    },
    "app_home": {
...
- If streaming fails mid-reply, RemoteClaw falls back to normal delivery for remaining payloads.
