...
/** Provider API families with first-class request/stream adapters in RemoteClaw. */
...
/** Image-generation API families with first-class adapters in RemoteClaw. */
...
/** Image provider ids with first-class adapters in RemoteClaw. */
...
export interface UserMessage {
   ...
   * (e.g. an RemoteClaw runtime-context carrier appended after the active user
...
export interface Model<TApi extends Api = Api> {
  ...
  reasoning: boolean;
  /**
   * Maps RemoteClaw thinking levels to provider/model-specific values.
