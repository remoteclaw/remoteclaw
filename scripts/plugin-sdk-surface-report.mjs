...
try {
  budgets = {
    publicEntrypoints: readBudgetEnv("REMOTECLAW_PLUGIN_SDK_MAX_PUBLIC_ENTRYPOINTS", 322),
    publicExports: readBudgetEnv("REMOTECLAW_PLUGIN_SDK_MAX_PUBLIC_EXPORTS", 10377),
    publicFunctionExports: readBudgetEnv("REMOTECLAW_PLUGIN_SDK_MAX_PUBLIC_FUNCTION_EXPORTS", 5206),
