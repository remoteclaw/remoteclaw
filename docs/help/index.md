...
- [Doctor](/gateway/doctor) - `remoteclaw doctor`: health checks, config migrations, repair steps
...
- [Environment variables](/help/environment) - where RemoteClaw loads env vars and precedence
...
- [RemoteClaw lore](/start/lore) - the story
