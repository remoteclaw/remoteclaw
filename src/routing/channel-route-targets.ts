...
function listConfiguredChannelIds(cfg: RemoteClawConfig): string[] {
...
function listConfiguredChannelAccountIds(cfg: RemoteClawConfig, channelId: string): string[] {
  if (!hasRecord(cfg.channels)) {
    return [];
  }
...
export function collectChannelRouteTargets(cfg: RemoteClawConfig): ChannelRouteTarget[] {
