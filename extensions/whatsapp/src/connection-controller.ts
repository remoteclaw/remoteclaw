...
import { info } from "remoteclaw/plugin-sdk/runtime-env";
...
export const WHATSAPP_LOGGED_OUT_RELINK_MESSAGE =
  "WhatsApp reported the session is logged out. Cleared cached web session; please rerun remoteclaw channels login and scan the QR again.";
