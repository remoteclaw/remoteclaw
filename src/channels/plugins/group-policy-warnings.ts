...
export function projectConfigWarningCollector<Params extends { cfg: RemoteClawConfig }>(
  collector: WarningCollector<{ cfg: RemoteClawConfig }>,
): WarningCollector<Params> {
...
export function projectAccountConfigWarningCollector<
  ResolvedAccount,
  ProjectedCfg,
  Params extends { account: ResolvedAccount; cfg: RemoteClawConfig },
>(
...
export function createAllowlistProviderRestrictSendersWarningCollector<ResolvedAccount>(
  ...
  return createAllowlistProviderGroupPolicyWarningCollector({
    providerConfigPresent: params.providerConfigPresent,
    resolveGroupPolicy: ({ account }: { account: ResolvedAccount; cfg: RemoteClawConfig }) =>
