import { asOptionalRecord as asRecord } from "remoteclaw/plugin-sdk/string-coerce-runtime";
...
export function shouldSkipRemoteClawSlackSelfEvent(args: SlackSelfFilterArgs): boolean {
