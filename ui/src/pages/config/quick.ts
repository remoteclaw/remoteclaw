...
import type { BorderRadiusStop } from "../../ui/storage.ts";
import { CONFIG_PRESETS, detectActivePreset, type ConfigPresetId } from "./presets.ts";
...
export type QuickSettingsProps = {
  // Fork-only: the fork shell routes to its own advanced settings view.
