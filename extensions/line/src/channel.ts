...
const lineConfigBase = createScopedChannelConfigBase<ResolvedLineAccount, RemoteClawConfig>({
  sectionKey: "line",
...
const resolveLineDmPolicy = createScopedDmSecurityResolver<ResolvedLineAccount>({
  ...
  approveHint: "remoteclaw pairing approve line <code>",
...
export const linePlugin: ChannelPlugin<ResolvedLineAccount> = {
  ...
  pairing: {
    ...
    notifyApproval: async ({ cfg, id }) => {
      ...
      await line.pushMessageLine(id, "RemoteClaw: your access has been approved.", {
