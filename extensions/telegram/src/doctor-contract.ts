...
} from "remoteclaw/plugin-sdk/runtime-doctor";
...
export const legacyConfigRules: ChannelDoctorLegacyConfigRule[] = [
  {
    ...
    message:
      'channels.telegram.groupMentionsOnly was removed; use channels.telegram.groups."*".requireMention instead. Run "remoteclaw doctor --fix".',
  },
  {
...
export function normalizeCompatibilityConfig({
  ...
  return {
    config: {
      ...
      channels: {
        ...cfg.channels,
        telegram: updated as unknown as NonNullable<RemoteClawConfig["channels"]>["telegram"],
