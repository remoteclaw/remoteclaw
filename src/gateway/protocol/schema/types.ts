...
export type NodeInvokeRequestEvent = SchemaType<"NodeInvokeRequestEvent">;
...
export type DevicePairRequestedEvent = SchemaType<"DevicePairRequestedEvent">;
export type DevicePairResolvedEvent = SchemaType<"DevicePairResolvedEvent">;
export type ChatHistoryParams = SchemaType<"ChatHistoryParams">;
export type ChatSendParams = SchemaType<"ChatSendParams">;
...
export type SendParams = SchemaType<"SendParams">;
