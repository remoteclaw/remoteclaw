...
<AccordionGroup>
  ...
  <Accordion title="Runtime and storage subpaths">
    ...
    | `plugin-sdk/agent-harness` | Experimental trusted-plugin surface for low-level agent harnesses: harness types, active-run steer/abort helpers, RemoteClaw tool bridge helpers, tool progress formatting/detail helpers, and attempt result utilities |
