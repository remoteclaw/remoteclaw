...
final class TalkModeManager: NSObject {
    ...
    private let logger = Logger(subsystem: "org.remoteclaw", category: "TalkMode")
    ...
    private func streamAssistant(runId: String, gateway: GatewayNodeSession) async {
        ...
        for await evt in stream {
            ...
            guard let agentEvent = try? GatewayPayloadDecoding.decode(payload, as: RemoteClawAgentEventPayload.self) else {
                continue
            }
