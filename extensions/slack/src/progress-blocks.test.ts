      ...
      lines: [
        {
          ...
          icon: "🛠️",
          label: "Exec",
          detail: "run tests in /Users/example/Projects/remoteclaw/packages/very/deep/path/example",
          text: "🛠️ Exec: run tests in /Users/example/Projects/remoteclaw/packages/very/deep/path/example",
        },
      ],
    });
