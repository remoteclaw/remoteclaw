import type { LineChannelData, RemoteClawPluginApi, ReplyPayload } from "remoteclaw/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: RemoteClawPluginApi): void {
  api.registerCommand({
    name: "card",
