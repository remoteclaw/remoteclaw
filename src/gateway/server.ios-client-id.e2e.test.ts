...
beforeAll(async () => {
  previousToken = process.env.REMOTECLAW_GATEWAY_TOKEN;
  process.env.REMOTECLAW_GATEWAY_TOKEN = "test-gateway-token-1234567890";
...
test.each([
  { clientId: "remoteclaw-ios", platform: "ios" },
  { clientId: "remoteclaw-android", platform: "android" },
