...
function parseArgs(argv, env = process.env) {
  return parseFlagArgs(
    argv,
    {
      ...
      maxWallMs: readBudgetEnvNumber("REMOTECLAW_TEST_PERF_MAX_WALL_MS", env),
      baselineWallMs: readBudgetEnvNumber("REMOTECLAW_TEST_PERF_BASELINE_WALL_MS", env),
      maxRegressionPct: readBudgetEnvNumber("REMOTECLAW_TEST_PERF_MAX_REGRESSION_PCT", env) ?? 10,
    },
    [
