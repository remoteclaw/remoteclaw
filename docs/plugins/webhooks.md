...
managed RemoteClaw TaskFlows over HTTP, without writing a custom plugin.
...
`Authorization: Bearer <secret>` or `x-remoteclaw-webhook-secret: <secret>`:
