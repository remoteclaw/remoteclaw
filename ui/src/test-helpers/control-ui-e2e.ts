...
function normalizeScenario(
  ...
  return {
    ...
    assistantName: scenario.assistantName?.trim() || "RemoteClaw",
    defaultAgentId,
...
function installControlUiMockGateway(input: {
  ...
  type WindowWithGateway = Window & {
    remoteclawControlUiE2eGateway?: ExposedGateway;
  };
  ...
  (window as WindowWithGateway).remoteclawControlUiE2eGateway = exposed;
