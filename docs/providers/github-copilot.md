...
```bash
remoteclaw models auth login-github-copilot
```
...
```bash
remoteclaw models auth login-github-copilot --profile-id github-copilot:work
remoteclaw models auth login-github-copilot --yes
```

## Set a default model

```bash
remoteclaw models set github-copilot/gpt-4o
```
