...
export async function resolveTlonSetupConfigured(cfg: RemoteClawConfig): Promise<boolean> {
...
export async function resolveTlonSetupStatusLines(cfg: RemoteClawConfig): Promise<string[]> {
