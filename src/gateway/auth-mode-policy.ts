...
export function hasAmbiguousGatewayAuthModeConfig(cfg: RemoteClawConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: RemoteClawConfig): void {
