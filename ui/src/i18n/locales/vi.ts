...
export const vi: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      qrAlt: "Mã QR ghép nối RemoteClaw di động",
      ...
      review: "Đánh giá",
      waiting: "Các ứng dụng di động RemoteClaw chính thức sẽ tự động kết nối sau khi quét.",
  ...
  worktrees: {
    ...
    subtitle: "Các bản checkout kho lưu trữ được cô lập do RemoteClaw sở hữu.",
  ...
  subtitles: {
    ...
    config: "Chỉnh sửa remoteclaw.json.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Đang dùng di động? Sao chép URL đầy đủ (bao gồm #token=...) từ remoteclaw dashboard --no-open trên máy tính của bạn.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — xác thực lại bằng remoteclaw models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "Dán token từ remoteclaw dashboard --no-open hoặc nhập mật khẩu đã cấu hình.",
        stepGenerate:
          "Nếu chưa cấu hình token, hãy chạy remoteclaw doctor --generate-gateway-token trên máy chủ Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard: "Chạy remoteclaw dashboard --no-open rồi mở URL mới hoặc dán token của nó.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Chạy remoteclaw devices list trên máy chủ Gateway.",
        stepApproveId: "Phê duyệt yêu cầu này: remoteclaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Mở lại dashboard được phục vụ bằng remoteclaw dashboard để UI và Gateway đến từ cùng một bản cài đặt.",
        stepDevUi:
          "Nếu dùng pnpm ui:dev, hãy build lại hoặc khởi động lại UI dev theo checkout hiện tại.",
        stepRestart:
          "Khởi động lại Gateway sau khi cập nhật RemoteClaw để nó phục vụ giao thức hiện tại.",
      },
      network: {
        ...
        stepGateway:
          "Xác nhận Gateway đang chạy bằng remoteclaw status hoặc remoteclaw gateway run.",
        stepUrl: "Kiểm tra WebSocket URL và dùng wss:// khi Gateway nằm sau HTTPS/Tailscale Serve.",
        stepDashboard:
          "Mở lại dashboard bằng remoteclaw dashboard --no-open để sao chép lại URL và chi tiết auth hiện tại.",
      },
    },
  },
  connection: {
