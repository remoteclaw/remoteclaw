...
const DEFAULT_CLAWHUB_SOURCE_REPO = "remoteclaw/clawhub";
const CLAWHUB_DOCS_TARGET_DIR = "clawhub";
const CLAWHUB_REPO_ENV = "REMOTECLAW_DOCS_SYNC_CLAWHUB_REPO";
...
const SYNC_SUPPORT_FILES = [
  {
    ...
    target: path.join(".remoteclaw-sync", "check-docs-mdx.mjs"),
  },
  {
    source: path.join(ROOT, "scripts", "lib", "mintlify-accordion.mjs"),
    target: path.join(".remoteclaw-sync", "lib", "mintlify-accordion.mjs"),
  },
  {
    source: path.join(ROOT, ".github", "codex", "prompts", "docs-mdx-repair.md"),
    target: path.join(".remoteclaw-sync", "docs-mdx-repair.md"),
  },
];
...
export function parseArgs(argv) {
  const args = {
    ...
    clawhubSourceRepo:
      process.env.REMOTECLAW_DOCS_SYNC_CLAWHUB_SOURCE_REPO || DEFAULT_CLAWHUB_SOURCE_REPO,
    clawhubSourceSha: process.env.REMOTECLAW_DOCS_SYNC_CLAWHUB_SOURCE_SHA || "",
  };
...
function writeSyncMetadata(targetRoot, args, sources) {
  ...
  writeJson(path.join(targetRoot, ".remoteclaw-sync", "source.json"), metadata);
}
