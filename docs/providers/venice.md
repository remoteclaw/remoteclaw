...
```bash
remoteclaw agent --model venice/llama-3.3-70b --message "Hello, are you working?"
```
...
remoteclaw agent --model venice/llama-3.3-70b --message "Quick health check"

# Use Claude via Venice (anonymized)
remoteclaw agent --model venice/claude-opus-45 --message "Summarize this task"
