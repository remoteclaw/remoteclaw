...
export const MODULE_ATTESTATIONS = {
  createCodeModeNamespaceTool: "live",
  registerCodeModeNamespaceForPlugin: "live",
  unregisterCodeModeNamespace: "live",
  listCodeModeNamespaces: "live",
  clearCodeModeNamespacesForTest: "live",
  clearCodeModeNamespacesForPlugin: "live",
  createCodeModeApiVirtualFiles: "live",
  describeCodeModeNamespacesForPrompt: "live",
  createCodeModeNamespaceRuntime: "live",
} as const;

const FORBIDDEN_NAMESPACE_PATH_SEGMENTS = new Set(["__proto__", "constructor", "prototype"]);
const NAMESPACE_PATH_KEY_SEPARATOR = "\u0000";
const CODE_MODE_NAMESPACE_TOOL_CALL = Symbol.for("remoteclaw.codeMode.namespaceToolCall");
...
const CODE_MODE_NAMESPACE_REGISTRY_KEY = Symbol.for("remoteclaw.codeMode.namespaces");
...
function normalizeRegistration(
  ...
  if (RESERVED_NAMESPACE_GLOBALS.has(globalName) || globalName.startsWith("__remoteclaw")) {
