...
read_when:
  - Deciding how to automate work with RemoteClaw
...
RemoteClaw provides several automation mechanisms, each suited to different use cases. This page helps you choose the right one.
