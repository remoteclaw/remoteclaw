---
summary: "RemoteClaw Amazon Bedrock Mantle provider plugin for OpenAI-compatible model routing."
read_when:
...
RemoteClaw Amazon Bedrock Mantle provider plugin for OpenAI-compatible model routing.
