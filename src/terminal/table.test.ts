...
describe("renderTable", () => {
  ...
  it("trims leading spaces on wrapped ANSI-colored continuation lines", () => {
    ...
    // Continuation lines must preserve ANSI styling without leading-space artifacts.
    // The wrap boundary itself depends on measurement heuristics — assert the
    // ANSI-preservation property, not the specific word at the boundary.
