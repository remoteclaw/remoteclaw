...
<AccordionGroup>
  ...
  <Accordion title="Can I use GPT 5.5 for daily tasks and Codex 5.5 for coding?">
    ...
    - **Native Codex coding agent:** set `agents.defaults.model.primary` to `openai/gpt-5.5`. Sign in with `remoteclaw models auth login --provider openai-codex` when you want ChatGPT/Codex subscription auth.
