...
- `REMOTECLAW_EXTENSIONS` — pre-install extension dependencies (space-separated extension names, e.g. `diagnostics-otel matrix`)
...
`setup-podman.sh` creates a dedicated system user `remoteclaw`:
