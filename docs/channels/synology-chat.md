...
Synology Chat ships as a bundled plugin in current RemoteClaw releases, so normal
...
remoteclaw message send --channel synology-chat --target synology:123456 --text "Short prefix"
```
