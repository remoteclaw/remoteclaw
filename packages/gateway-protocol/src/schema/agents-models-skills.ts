...
export const AgentSummarySchema = Type.Object(
  {
    ...
    agentRuntime: Type.Optional(
      Type.Object(
        {
          id: NonEmptyString,
          fallback: Type.Optional(Type.Union([Type.Literal("remoteclaw"), Type.Literal("none")])),
          source: Type.Union([
            Type.Literal("env"),
            Type.Literal("agent"),
...
export const SkillsSecurityVerdictsResultSchema = Type.Object(
  {
    schema: Type.Literal("remoteclaw.skills.security-verdicts.v1"),
    items: Type.Array(
      Type.Object(
        {
...
export const SkillsSkillCardResultSchema = Type.Object(
  {
    schema: Type.Literal("remoteclaw.skills.skill-card.v1"),
    skillKey: NonEmptyString,
    path: NonEmptyString,
...
const SkillProposalRecordSchema = Type.Object(
  {
    schema: Type.Literal("remoteclaw.skill-workshop.proposal.v1"),
    id: NonEmptyString,
...
export const SkillsProposalsListResultSchema = Type.Object(
  {
    schema: Type.Literal("remoteclaw.skill-workshop.proposals-manifest.v1"),
    updatedAt: NonEmptyString,
