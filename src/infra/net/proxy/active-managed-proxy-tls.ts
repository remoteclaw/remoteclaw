// Resolves RemoteClaw-managed proxy TLS trust for non-Undici transports.
...
const MANAGED_PROXY_ENV_PREFIX = ["REMOTECLAW", "PROXY"].join("_");
...
/** Resolves managed proxy TLS trust only when the target proxy is RemoteClaw's active proxy. */
