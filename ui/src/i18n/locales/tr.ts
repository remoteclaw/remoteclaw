...
export const tr: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      qrAlt: "RemoteClaw mobil eşleştirme QR kodu",
      ...
      review: "İnceleme",
      waiting: "Resmi RemoteClaw mobil uygulamaları taramadan sonra otomatik olarak bağlanır.",
  ...
  worktrees: {
    ...
    subtitle: "RemoteClaw tarafından sahip olunan yalıtılmış depo checkout'ları.",
  ...
  subtitles: {
    ...
    config: "remoteclaw.json dosyasını düzenleyin.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Mobilde misiniz? Masaüstünüzde remoteclaw dashboard --no-open komutundan tam URL'yi (#token=... dahil) kopyalayın.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — remoteclaw models auth ile yeniden kimlik doğrulayın",
