...
actor MacNodeRuntime {
    ...
    func handleInvoke(_ req: BridgeInvokeRequest) async -> BridgeInvokeResponse {
        ...
        do {
            ...
            case RemoteClawBrowserCommand.proxy.rawValue:
            ...
            case RemoteClawLocationCommand.get.rawValue:
                return try await self.handleLocationInvoke(req)
            case MacNodeScreenCommand.record.rawValue:
                return try await self.handleScreenRecordInvoke(req)
            case RemoteClawSystemCommand.run.rawValue:
                return try await self.handleSystemRun(req)
            case RemoteClawSystemCommand.which.rawValue:
                return try await self.handleSystemWhich(req)
            case RemoteClawSystemCommand.notify.rawValue:
                return try await self.handleSystemNotify(req)
            case RemoteClawSystemCommand.execApprovalsGet.rawValue:
                return try await self.handleSystemExecApprovalsGet(req)
            case RemoteClawSystemCommand.execApprovalsSet.rawValue:
    ...
    private func handleA2UIInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        case RemoteClawCanvasA2UICommand.push.rawValue,
             RemoteClawCanvasA2UICommand.pushJSONL.rawValue:
    ...
    private func resolveA2UIHostUrl() async -> String? {
        ...
        return baseUrl.appendingPathComponent("__remoteclaw__/a2ui/").absoluteString + "?platform=macos"
    }
    ...
    private func handleSystemRun(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(RemoteClawSystemRunParams.self, from: req.paramsJSON)
    ...
    private func handleSystemWhich(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(RemoteClawSystemWhichParams.self, from: req.paramsJSON)
    ...
    private func resolveSystemRunApproval(
        ...
        params: RemoteClawSystemRunParams,
...
extension MacNodeRuntime {
    ...
    private nonisolated static func locationMode() -> RemoteClawLocationMode {
        ...
        message: String) -> BridgeInvokeResponse
    {
        BridgeInvokeResponse(
            id: req.id,
            ok: false,
            error: RemoteClawNodeError(code: code, message: message))
    }
