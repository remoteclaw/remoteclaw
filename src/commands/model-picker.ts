...
type PromptDefaultModelResult = { model?: string; config?: RemoteClawConfig };
...
function resolveConfiguredModelRaw(cfg: RemoteClawConfig): string {
...
function resolveConfiguredModelKeys(cfg: RemoteClawConfig): string[] {
...
export function applyPrimaryModel(cfg: RemoteClawConfig, model: string): RemoteClawConfig {
...
export function applyModelAllowlist(cfg: RemoteClawConfig, models: string[]): RemoteClawConfig {
  const defaults = cfg.agents?.defaults;
