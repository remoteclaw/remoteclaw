...
function resolveWatchPaths(workspaceDir: string, config?: RemoteClawConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: RemoteClawConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: RemoteClawConfig }) {
