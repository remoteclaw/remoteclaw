...
// Summarizes RemoteClaw performance source fixtures for reports.
...
function printHelp() {
  console.log(`Usage: node scripts/remoteclaw-performance-source-summary.mjs --source-dir <dir> [--baseline-source-dir <dir>] [--output <summary.md>]

Summarizes RemoteClaw-native performance probe artifacts for CI reports.`);
}
