...
RemoteClaw treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.remoteclaw/settings/voicewake.json`

Shape:

```json
{ "triggers": ["remoteclaw", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
