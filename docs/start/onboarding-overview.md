---
summary: "Overview of RemoteClaw onboarding options and flows"
read_when:
...
RemoteClaw supports multiple onboarding paths depending on where the Gateway runs
...
- [`remoteclaw onboard` command](/cli/onboard)

## macOS app onboarding

Use the RemoteClaw app when you want a fully guided setup on macOS. Docs:
