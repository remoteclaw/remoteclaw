...
import org.remoteclaw.app.ui.mobileSurface
import org.remoteclaw.app.ui.mobileText
import org.remoteclaw.app.ui.mobileTextSecondary
import org.remoteclaw.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = org.remoteclaw.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = org.remoteclaw.app.ui.mobileFontFamily,
