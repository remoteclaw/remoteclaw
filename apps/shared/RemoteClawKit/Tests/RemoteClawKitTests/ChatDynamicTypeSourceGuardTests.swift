...
struct ChatDynamicTypeSourceGuardTests {
        ...
        composer: String)
    {
        ...
        return try (
            messageViews: String(
                contentsOf: root.appendingPathComponent("Sources/RemoteClawChatUI/ChatMessageViews.swift"),
                encoding: .utf8),
            chatView: String(
                contentsOf: root.appendingPathComponent("Sources/RemoteClawChatUI/ChatView.swift"),
                encoding: .utf8),
            composer: String(
                contentsOf: root.appendingPathComponent("Sources/RemoteClawChatUI/ChatComposer.swift"),
                encoding: .utf8))
    }
}
