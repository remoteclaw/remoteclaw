...
export type AcpxPluginConfig = {
  ...
  remoteClawToolsMcpBridge?: boolean;
...
/** Zod schema for validating raw ACPX plugin config from RemoteClaw config. */
export const AcpxPluginConfigSchema = z.strictObject({
  ...
  remoteClawToolsMcpBridge: z
    .boolean({ error: "remoteClawToolsMcpBridge must be a boolean" })
    .optional(),
