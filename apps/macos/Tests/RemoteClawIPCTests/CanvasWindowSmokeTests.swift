...
struct CanvasWindowSmokeTests {
    ...
    @Test func `A2UI auto navigation is idempotent for current host target`() throws {
        ...
        let oldTarget = "http://127.0.0.1:18789/__remoteclaw__/a2ui/?platform=macos"
        let currentTarget = "http://127.0.0.1:18790/__remoteclaw__/a2ui/?platform=macos"
        let userTarget = "https://github.com/remoteclaw/remoteclaw"
