...
import Ajv from "ajv";
// NOTE: This extension is intended to be bundled with RemoteClaw.
// When running from source (tests/dev), RemoteClaw internals live under src/.
...
export function createLlmTaskTool(api: RemoteClawPluginApi) {
  return {
    name: "llm-task",
    label: "LLM Task",
    description:
