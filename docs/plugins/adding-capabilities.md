---
summary: "Contributor guide for adding a new shared capability to the RemoteClaw plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for RemoteClaw core developers. If you are
...
Use this when RemoteClaw needs a new shared domain such as image generation, video generation, or some future vendor-backed feature area.
