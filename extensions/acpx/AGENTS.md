...
The ACPX extension is a thin RemoteClaw wrapper around the published `acpx` package. Keep reusable ACP runtime logic in `remoteclaw/acpx`, not in this extension.
