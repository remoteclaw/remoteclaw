...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://remoteclaw.local")).toBe("https://remoteclaw.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://remoteclaw.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: remoteclaw security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://remoteclaw.local" },
      ...
      { Item: "Security", Value: "Run: remoteclaw security audit --deep" },
