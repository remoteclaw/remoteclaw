...
final class ScreenSnapshotService {
    ...
    func snapshot(
        ...
        maxWidth: Int?,
        quality: Double?,
        format: RemoteClawScreenSnapshotFormat?) async throws
        -> (data: Data, format: RemoteClawScreenSnapshotFormat, width: Int, height: Int)
    {
    ...
    private static func normalize(
        maxWidth: Int?,
        quality: Double?,
        format: RemoteClawScreenSnapshotFormat)
