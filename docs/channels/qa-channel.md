...
`qa-channel` is a bundled synthetic message transport for automated RemoteClaw QA.
...
- Dockerized RemoteClaw orchestration
- provider/model matrix execution
- richer scenario discovery
- RemoteClaw-native orchestration later
