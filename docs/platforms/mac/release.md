---
description: "RemoteClaw macOS release checklist (Sparkle feed, packaging, signing)"
read_when:
...
ditto -c -k --sequesterRsrc --keepParent dist/RemoteClaw.app dist/RemoteClaw-2026.3.11.zip

# Optional: build a styled DMG for humans (drag to /Applications)
scripts/create-dmg.sh dist/RemoteClaw.app dist/RemoteClaw-2026.3.11.dmg
...
```bash
SPARKLE_PRIVATE_KEY_FILE=/path/to/ed25519-private-key scripts/make_appcast.sh dist/RemoteClaw-2026.3.11.zip https://raw.githubusercontent.com/remoteclaw/remoteclaw/main/appcast.xml
```
...
- Upload `RemoteClaw-2026.3.11.zip` (and `RemoteClaw-2026.3.11.dSYM.zip`) to the GitHub release for tag `v2026.3.11`.
