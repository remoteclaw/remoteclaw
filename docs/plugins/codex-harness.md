...
By default, RemoteClaw asks Codex to request native approvals. You can tune that
...
- `REMOTECLAW_CODEX_APP_SERVER_GUARDIAN=1`
...
**RemoteClaw falls back to PI:** set `embeddedHarness.fallback: "none"` or
`REMOTECLAW_AGENT_HARNESS_FALLBACK=none` while testing.
