...
actor RemoteTunnelManager {
    ...
    private let logger = Logger(subsystem: "org.remoteclaw", category: "remote-tunnel")
    ...
    func controlTunnelPortIfRunning() async -> UInt16? {
        ...
        // If a previous RemoteClaw run already has an SSH listener on the expected port (common after restarts),
