...
export const PLUGIN_INSTALL_OVERRIDES_ENV = "REMOTECLAW_PLUGIN_INSTALL_OVERRIDES";
export const ALLOW_PLUGIN_INSTALL_OVERRIDES_ENV = "REMOTECLAW_ALLOW_PLUGIN_INSTALL_OVERRIDES";
