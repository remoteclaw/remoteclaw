...
function setNostrDmPolicy(cfg: RemoteClawConfig, dmPolicy: DmPolicy): RemoteClawConfig {
...
function setNostrAllowFrom(cfg: RemoteClawConfig, allowFrom: string[]): RemoteClawConfig {
