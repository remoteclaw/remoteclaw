...
export const FIELD_HELP: Record<string, string> = {
  ...
  "agents.defaults.embeddedHarness":
    "Default embedded agent harness policy. Omitted runtime uses built-in RemoteClaw Pi. Use runtime=auto for plugin harness selection, or a registered harness id such as codex.",
  "agents.defaults.embeddedHarness.runtime":
    "Embedded harness runtime: pi, auto, or a registered plugin harness id such as codex. Omitted runtime uses built-in RemoteClaw Pi.",
  ...
  "agents.list.*.embeddedHarness.runtime":
    "Per-agent embedded harness runtime: pi, auto, or a registered plugin harness id such as codex. Omitted runtime inherits the default RemoteClaw Pi behavior.",
