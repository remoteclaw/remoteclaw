...
| Commits         | `scripts/committer "<message>" <files...>`                                     | Preferred scoped commit helper for RemoteClaw changes.                                                             |
...
- `release-*`, `remoteclaw-npm-*`, and `plugin-*-release-*`: release preparation,
...
See also [Scripts](https://docs.remoteclaw.org/help/scripts) for public-facing script guidance.
