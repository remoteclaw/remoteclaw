...
/** Parse `remoteclaw health` flags for the route-first status family. */
...
/** Parse `remoteclaw status` flags without registering the full command tree. */
...
/** Parse `remoteclaw gateway status` RPC-only flags accepted by the fast route. */
...
/** Parse `remoteclaw sessions` filters for JSON/list route execution. */
...
/** Parse `remoteclaw agents list` display switches for route-first execution. */
...
/** Parse `remoteclaw config get <path>` while preserving root option handling. */
...
/** Parse `remoteclaw config unset <path>` and its mutation guard flags. */
...
/** Parse `remoteclaw models list` filters for the lightweight model catalog route. */
...
/** Parse `remoteclaw models status` probe controls for the route-first status path. */
...
/** Parse `remoteclaw channels list` display flags for the route-first list path. */
...
/** Parse `remoteclaw channels status` probe flags without full CLI registration. */
...
/** Parse JSON-only `remoteclaw plugins list` flags for plugin inventory output. */
...
/** Parse both `remoteclaw tasks --json` and `remoteclaw tasks list --json` aliases. */
...
/** Parse JSON-only `remoteclaw tasks audit` filters for the route-first audit path. */
