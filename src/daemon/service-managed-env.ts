...
const MANAGED_SERVICE_ENV_KEYS_VAR = "REMOTECLAW_SERVICE_MANAGED_ENV_KEYS";

// Tracks which service environment keys RemoteClaw owns across reinstall/start flows.
