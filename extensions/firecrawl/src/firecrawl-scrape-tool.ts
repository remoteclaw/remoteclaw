...
import { optionalStringEnum } from "remoteclaw/plugin-sdk/agent-runtime";
import { jsonResult, readNumberParam, readStringParam } from "remoteclaw/plugin-sdk/agent-runtime";
...
export function createFirecrawlScrapeTool(api: RemoteClawPluginApi) {
  return {
