...
function createMatrixThreadCommandParams(commandBody: string, cfg: RemoteClawConfig = baseCfg) {
...
function createMatrixRoomCommandParams(commandBody: string, cfg: RemoteClawConfig = baseCfg) {
  const params = buildCommandTestParams(commandBody, cfg, {
    Provider: "matrix",
    Surface: "matrix",
    OriginatingChannel: "matrix",
