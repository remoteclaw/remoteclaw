...
import type {
  RemoteClawPluginCliCommandDescriptor,
  RemoteClawPluginCliContext,
  PluginLogger,
} from "./types.js";
...
export type PluginCliCommandGroupEntry = {
  pluginId: string;
  placeholders: readonly RemoteClawPluginCliCommandDescriptor[];
  names: readonly string[];
  register: (program: RemoteClawPluginCliContext["program"]) => Promise<void>;
};
...
export async function loadPluginCliMetadataRegistryWithContext(
  ...
  return {
    ...context,
    registry: await loadRemoteClawPluginCliRegistry(
...
export async function loadPluginCliCommandRegistryWithContext(params: {
  ...
  return {
    ...params.context,
    registry: loadRemoteClawPlugins(
...
): Promise<RemoteClawPluginCliCommandDescriptor[]> {
  try {
