...
const UPDATE_BANNER_DISMISS_KEY = "remoteclaw:control-ui:update-banner-dismissed:v1";
      ...
      ${
        ...
        !isDismissed(updateAvailable)
          ? html`<div class="update-banner callout danger" role="alert">
            ...
            <remoteclaw-tooltip .content=${t("common.dismiss")}>
              <button
...
if (!customElements.get("remoteclaw-update-banner")) {
  customElements.define("remoteclaw-update-banner", UpdateBanner);
}
