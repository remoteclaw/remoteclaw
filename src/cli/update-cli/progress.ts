...
const STEP_LABELS: Record<string, string> = {
  ...
  "remoteclaw doctor entry": "Checking doctor entrypoint",
...
export function inferUpdateFailureHints(result: UpdateRunResult): string[] {
  ...
  if (isGlobalPackageInstallStep && stderr.includes("eacces")) {
    ...
    hints.push(
      "System install outline: remoteclaw gateway stop -> sudo <system-npm> i -g remoteclaw@latest -> remoteclaw gateway install --force -> remoteclaw gateway restart.",
    );
  }
