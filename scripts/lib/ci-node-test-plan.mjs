...
const GATEWAY_STARTUP_HEALTH_RUNTIME_ENV = {
  REMOTECLAW_VITEST_NO_OUTPUT_TIMEOUT_MS: "60000",
};
...
function resolveAgentCoreShardName(file) {
  ...
  if (
    ...
    name.startsWith("remoteclaw-tools") ||
...
function resolveInfraShardName(file) {
  ...
  if (
    ...
    name.startsWith("tmp-remoteclaw-dir")
  ) {
  ...
  if (
    ...
    name.startsWith("remoteclaw-exec-env") ||
  ...
  if (
    ...
    name.startsWith("git-") ||
    name.startsWith("remoteclaw-root") ||
  ...
  [
    ...
    [
      ...
      },
      {
        ...
        env: {
          REMOTECLAW_TUI_PTY_INCLUDE_LOCAL: "1",
        },
        requiresDist: false,
        runner: "blacksmith-4vcpu-ubuntu-2404",
      },
