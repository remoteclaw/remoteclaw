...
RemoteClaw can convert outbound replies into audio using ElevenLabs, OpenAI, or Edge TTS.
...
Edge TTS does **not** require an API key. If no API keys are found, RemoteClaw defaults
