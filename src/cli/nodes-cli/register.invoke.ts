...
// oxlint-disable-next-line typescript/no-explicit-any
const minSecurity = (..._args: unknown[]) => undefined as any;
// oxlint-disable-next-line typescript/no-explicit-any
const resolveExecApprovalsFromFile = (..._args: unknown[]) => undefined as any;
import { buildNodeShellCommand } from "../../infra/node-shell.js";
import { applyPathPrepend } from "../../infra/path-prepend.js";
// Gutted in RemoteClaw fork (Middleware Boundary Principle)
// import ... from "../../infra/system-run-approval-context.js";
// oxlint-disable-next-line typescript/no-explicit-any
const parsePreparedSystemRunPayload = (..._args: unknown[]) => undefined as any;
