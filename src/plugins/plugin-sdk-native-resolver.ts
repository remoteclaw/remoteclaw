...
export type InstallRemoteClawPluginSdkNativeResolverOptions = {
  modulePath?: string;
...
const PLUGIN_SDK_PACKAGE_PREFIXES = ["remoteclaw/plugin-sdk", "remoteclaw/plugin-sdk"] as const;
...
function resolveLoaderModulePath(options: InstallRemoteClawPluginSdkNativeResolverOptions): string {
...
function registerAllowedParentRoots(
  options: InstallRemoteClawPluginSdkNativeResolverOptions,
): void {
...
export function installRemoteClawPluginSdkNativeResolver(
  options: InstallRemoteClawPluginSdkNativeResolverOptions = {},
): string[] {
...
export function resetRemoteClawPluginSdkNativeResolverForTest(): void {
