...
describe("discord config schema", () => {
  ...
  it("loads guild map and dm group settings", () => {
    ...
    expect(cfg.dm?.groupChannels).toEqual(["remoteclaw-dm"]);
    ...
    expect(cfg.guilds?.["123"]?.slug).toBe("friends-of-remoteclaw");
  ...
  it.each([
    ...
    },
    {
      ...
      config: { activity: "Live", activityUrl: "https://twitch.tv/remoteclaw" },
    },
    {
