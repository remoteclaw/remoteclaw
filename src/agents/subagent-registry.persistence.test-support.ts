...
export const MODULE_ATTESTATIONS = {
  resolveSubagentSessionStorePath: "live",
  readSubagentSessionStore: "live",
  writeSubagentSessionEntry: "live",
  removeSubagentSessionEntry: "live",
  createSubagentRegistryTestDeps: "live",
} as const;
