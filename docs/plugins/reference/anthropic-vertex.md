---
summary: "RemoteClaw Anthropic Vertex provider plugin for Claude models on Google Vertex AI."
read_when:
...
RemoteClaw Anthropic Vertex provider plugin for Claude models on Google Vertex AI.
