...
enum UIStrings {
    static let welcomeTitle = "Welcome to RemoteClaw"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "remoteclaw.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: RemoteClawOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: RemoteClawChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g remoteclaw@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: RemoteClawChatViewModel(
