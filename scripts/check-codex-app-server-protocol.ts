...
const codexRepo = process.env.REMOTECLAW_CODEX_REPO
  ? path.resolve(process.env.REMOTECLAW_CODEX_REPO)
...
console.log(
  `Codex app-server generated protocol matches RemoteClaw bridge assumptions: ${schemaRoot}`,
);
