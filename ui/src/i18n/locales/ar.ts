...
export const ar: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      title: "RemoteClaw للأجهزة المحمولة",
      ...
      qrAlt: "رمز QR لإقران RemoteClaw للأجهزة المحمولة",
      ...
      review: "مراجعة",
      waiting: "تتصل تطبيقات RemoteClaw الرسمية للأجهزة المحمولة تلقائيًا بعد المسح.",
      help: "مساعدة الإقران",
  ...
  worktrees: {
    ...
    subtitle: "نسخ مستودعات معزولة مملوكة لـ RemoteClaw.",
    cleanNow: "تنظيف الآن",
    name: "الاسم",
    repo: "المستودع",
    branch: "الفرع",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "على الهاتف؟ انسخ عنوان URL الكامل (بما في ذلك #token=...) من remoteclaw dashboard --no-open على سطح المكتب.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — أعد المصادقة باستخدام remoteclaw models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "الصق الرمز المميز من remoteclaw dashboard --no-open أو أدخل كلمة المرور المكونة.",
        stepGenerate:
          "إذا لم يتم تكوين رمز مميز، فشغل remoteclaw doctor --generate-gateway-token على مضيف Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "شغل remoteclaw dashboard --no-open وافتح عنوان URL الجديد أو الصق رمزه المميز.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "شغل remoteclaw devices list على مضيف Gateway.",
        stepApproveId: "وافق على هذا الطلب: remoteclaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "أعد فتح لوحة المعلومات المقدمة باستخدام remoteclaw dashboard حتى يأتي UI وGateway من التثبيت نفسه.",
        stepDevUi:
          "إذا كنت تستخدم pnpm ui:dev، فأعد بناء أو تشغيل واجهة التطوير مقابل checkout الحالي.",
        stepRestart: "أعد تشغيل Gateway بعد تحديث RemoteClaw حتى يقدم البروتوكول الحالي.",
      },
      network: {
        title: "تعذر الاتصال",
        summary:
        ...
        stepGateway:
          "تأكد من أن Gateway يعمل باستخدام remoteclaw status أو remoteclaw gateway run.",
        stepUrl:
          "تحقق من عنوان WebSocket واستخدم wss:// عندما يكون Gateway خلف HTTPS/Tailscale Serve.",
        stepDashboard:
          "أعد فتح لوحة المعلومات باستخدام remoteclaw dashboard --no-open لنسخ عنوان URL وتفاصيل المصادقة الحالية.",
      },
    },
  },
  connection: {
