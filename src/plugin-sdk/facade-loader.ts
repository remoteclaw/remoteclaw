...
let cachedRemoteClawPackageRoot: string | undefined;
...
function getRemoteClawPackageRoot() {
  if (cachedRemoteClawPackageRoot) {
    return cachedRemoteClawPackageRoot;
  }
  cachedRemoteClawPackageRoot =
...
function resolveFacadeModuleLocationUncached(params: {
  ...
  return resolveBundledFacadeModuleLocation({
    ...
    packageRoot: getRemoteClawPackageRoot(),
    bundledPluginsDir,
  });
}
...
export function loadFacadeModuleAtLocationSync<T extends object>(params: {
  ...
  const opened = openBoundaryFileSync({
    ...
    boundaryLabel:
      params.location.boundaryRoot === getRemoteClawPackageRoot()
...
export function resetFacadeLoaderStateForTest(): void {
  ...
  cachedRemoteClawPackageRoot = undefined;
}
