...
describe("normalizeStoredCronJobs", () => {
  ...
  // Note: payload.provider → delivery.channel migration was gutted in the fork
  // (migrateLegacyCronPayload is a no-op stub). The corresponding upstream test
  // was dropped during the v2026.3.11 sync to align with fork contract.
});
