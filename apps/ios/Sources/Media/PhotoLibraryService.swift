...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: RemoteClawPhotosLatestParams) async throws -> RemoteClawPhotosLatestPayload {
        ...
        var results: [RemoteClawPhotoPayload] = []
        ...
        return RemoteClawPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> RemoteClawPhotoPayload
    {
