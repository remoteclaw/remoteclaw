...
const TTS_PROVIDERS: TtsProviderImpl[] = [openaiTtsProvider, elevenLabsTtsProvider, edgeTtsProvider];

export function normalizeTtsProviderId(id: string): string {
  return normalizeProviderId(id);
}

export function buildTtsProviderRegistry(pluginProviders?: TtsProviderImpl[]): Map<string, TtsProviderImpl> {
...
export function getTtsProvider(id: string, registry: Map<string, TtsProviderImpl>): TtsProviderImpl | undefined {
