...
<Steps>
  <Step title="Install the plugin">
    ...
    If npm reports the RemoteClaw-owned package as deprecated, that package version
    is from an older external package train; use a current packaged RemoteClaw
