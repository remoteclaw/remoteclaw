...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). RemoteClaw uses
...
```bash
remoteclaw onboard --auth-choice xiaomi-api-key
# or non-interactive
remoteclaw onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
