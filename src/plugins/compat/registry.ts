...
export const PLUGIN_COMPAT_RECORDS = [
  ...
  },
  {
    ...
    deprecated: "2026-04-24",
    warningStarts: "2026-04-24",
    replacement: "focused `remoteclaw/plugin-sdk/<subpath>` imports",
    docsPath: "/plugins/sdk-migration",
    surfaces: ["remoteclaw/plugin-sdk", "remoteclaw/plugin-sdk/compat"],
    diagnostics: ["REMOTECLAW_PLUGIN_SDK_COMPAT_DEPRECATED"],
    tests: [
  ...
  },
  {
    ...
    surfaces: ["remoteclaw.plugin.json providerAuthEnvVars", "provider setup"],
  ...
  },
  {
    ...
    docsPath: "/plugins/manifest",
    surfaces: ["remoteclaw.plugin.json channelEnvVars", "channel setup"],
    diagnostics: ["manifest compatibility diagnostic"],
    tests: [
  ...
  },
  {
    ...
    deprecated: "2026-04-25",
    warningStarts: "2026-04-25",
    replacement: "`remoteclaw/plugin-sdk/agent-runtime`",
    docsPath: "/plugins/sdk-agent-harness",
    surfaces: [
      "remoteclaw/plugin-sdk/agent-harness",
      "remoteclaw/plugin-sdk/agent-harness-runtime",
    ],
