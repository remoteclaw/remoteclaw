...
export function resolveSandboxSessionToolsVisibility(cfg: RemoteClawConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: RemoteClawConfig): AgentToAgentPolicy {
