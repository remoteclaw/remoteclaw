...
export const en = {
  ...
  wizard: {
    ...
    gateway: {
      ...
      plaintextPasswordHint: "Stores the password directly in RemoteClaw config",
    ...
    migration: {
      ...
      complete: "Migration complete. Run `remoteclaw doctor` next.",
    ...
    plugins: {
      ...
      sensitiveField:
        '"{label}" is sensitive. Set it via:\n  remoteclaw config set plugins.entries.{plugin}.config.{field} <value>\nor use the Web UI Settings page.',
    ...
    remote: {
      ...
      insecureRemoteUrl:
        "Use wss:// for remote hosts, or ws://127.0.0.1/localhost via SSH tunnel. Break-glass: REMOTECLAW_ALLOW_INSECURE_PRIVATE_WS=1 for trusted private networks.",
      ...
      plaintextPasswordHint: "Stores the password directly in RemoteClaw config",
      plaintextPasswordLabel: "Enter password now",
      plaintextTokenHint: "Stores the token directly in RemoteClaw config",
    ...
    security: {
      ...
      beta: "RemoteClaw is a hobby project and still in beta. Expect sharp edges.",
      confirm:
        "I understand this is personal-by-default and shared/multi-user use requires lock-down. Continue?",
      hardeningRequired:
        "If you're not comfortable with security hardening and access control, don't run RemoteClaw.",
      learnMore: "Learn more",
      notMultitenant: "RemoteClaw is not a hostile multi-tenant boundary by default.",
      personalAgent: "By default, RemoteClaw is a personal agent: one trusted operator boundary.",
    ...
    skills: {
      ...
      docsLine: "Docs: https://docs.remoteclaw.org/skills",
      enterEnv: "Enter {env}",
      ...
      manualPrereqsDoctorHint:
        "Install those tools first, then run `remoteclaw doctor` to review skills + requirements.",
    ...
    nextcloudTalk: {
      ...
      helpInstallCommand:
        '2) Run: ./occ talk:bot:install "RemoteClaw" "<shared-secret>" "<webhook-url>" --feature webhook --feature response --feature reaction',
    ...
    whatsapp: {
      ...
      ownerNumberNote: "We need the sender/owner number so RemoteClaw can allowlist you.",
      ...
      separatePhoneLabel: "Separate phone just for RemoteClaw",
    ...
    irc: {
      ...
      nextStatusCommand: "Command: remoteclaw channels status --probe",
    ...
    synologyChat: {
      ...
      incomingWebhookHelpReplies: "This is the URL RemoteClaw uses to send replies back to Chat.",
    ...
    signal: {
      ...
      multipleEntries: "Multiple entries: comma-separated.",
      nextLinkDevice: 'Link device with: signal-cli link -n "RemoteClaw"',
    ...
    twitch: {
      ...
      envPrompt: "Twitch env var REMOTECLAW_TWITCH_ACCESS_TOKEN detected. Use env token?",
      ...
      helpEnvVars: "Env vars supported: REMOTECLAW_TWITCH_ACCESS_TOKEN",
    ...
    channelsPrimer: {
      ...
      blurbs: {
        ...
        synologyChat: "Connect your Synology NAS Chat to RemoteClaw with full agent capabilities.",
    ...
    search: {
      ...
      configured: "configured",
      configureLaterHint: "Configure later with remoteclaw configure --section web",
      docsLine: "Docs: {url}",
    ...
    finalize: {
      ...
      controlUiDocs: "Docs: https://docs.remoteclaw.org/web/control-ui",
      dashboardCopyPaste: "Copy/paste this URL in a browser on this machine to control RemoteClaw.",
      dashboardLinkWithToken: "Dashboard link (with token): {url}",
      dashboardOpened: "Opened in your browser. Keep that tab to control RemoteClaw.",
      ...
      daemonRuntimeNodeHint:
        "Required because RemoteClaw state uses node:sqlite; Bun cannot run the Gateway.",
      ...
      gatewayTokenStored:
        "Stored in: $REMOTECLAW_CONFIG_PATH (default: ~/.remoteclaw/remoteclaw.json) under gateway.auth.token, or in REMOTECLAW_GATEWAY_TOKEN.",
      ...
      containerSystemdUnavailable:
        "Systemd user services are not available inside this container. RemoteClaw is skipping only the background service install; run the Gateway in the foreground or use your container supervisor.",
      securityReminder:
      ...
      webDocs: "Docs: https://docs.remoteclaw.org/tools/web",
      ...
      whatNow: 'What now: https://remoteclaw.org/showcase ("What People Are Building").',
      whatNowTitle: "What now",
      workspaceBackupTitle: "Workspace backup",
      workspaceDocs: "Docs: https://docs.remoteclaw.org/concepts/agent-workspace",
