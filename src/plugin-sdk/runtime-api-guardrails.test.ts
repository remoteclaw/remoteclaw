...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  ...
  "extensions/telegram/runtime-api.ts": [
    'export type { ChannelPlugin, RemoteClawConfig, TelegramActionConfig } from "../../src/plugin-sdk/telegram-core.js";',
    ...
    'export type { RemoteClawPluginApi, RemoteClawPluginService, RemoteClawPluginServiceContext, PluginLogger } from "../../src/plugins/types.js";',
