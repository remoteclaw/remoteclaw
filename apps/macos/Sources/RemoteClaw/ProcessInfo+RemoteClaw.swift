...
extension ProcessInfo {
    ...
    {
        if environment["REMOTECLAW_NIX_MODE"] == "1" { return true }
        if standard.bool(forKey: "remoteclaw.nixMode") { return true }
        ...
        if isAppBundle, let stableSuite, stableSuite.bool(forKey: "remoteclaw.nixMode") { return true }
