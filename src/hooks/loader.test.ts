...
describe("loader", () => {
  ...
  beforeEach(async () => {
    ...
    originalBundledDir = process.env.REMOTECLAW_BUNDLED_HOOKS_DIR;
  ...
  afterEach(async () => {
    ...
    if (originalBundledDir === undefined) {
      delete process.env.REMOTECLAW_BUNDLED_HOOKS_DIR;
    } else {
      process.env.REMOTECLAW_BUNDLED_HOOKS_DIR = originalBundledDir;
    }
  });
