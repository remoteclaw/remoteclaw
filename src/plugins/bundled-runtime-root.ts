...
const BUNDLED_RUNTIME_MIRROR_LOCK_DIR = ".remoteclaw-runtime-mirror.lock";
...
function prepareBundledPluginRuntimeDistMirror(params: {
  ...
  ensureRemoteClawPluginSdkAlias(mirrorDistRoot);
...
function ensureRemoteClawPluginSdkAlias(distRoot: string): void {
