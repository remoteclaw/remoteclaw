...
export const COMPLETION_SKIP_PLUGIN_COMMANDS_ENV = "REMOTECLAW_COMPLETION_SKIP_PLUGIN_COMMANDS";
...
/** Resolves the shell startup profile path that should contain the RemoteClaw completion block. */
...
/** Returns whether a shell profile already contains an RemoteClaw completion block or source line. */
