...
struct LocationPermissionSummary: Equatable {
    var desiredMode: RemoteClawLocationMode
    var locationServicesEnabled: Bool
    var authorizationStatus: CLAuthorizationStatus
    var accuracyAuthorization: CLAccuracyAuthorization

    var effectiveMode: RemoteClawLocationMode {
    ...
    var detailText: String {
        ...
        {
        case (.off, false, _, _):
            "Location sharing is disabled in RemoteClaw. Location Services are off in iOS Settings."
        case (.off, true, .authorizedAlways, _):
            "Location sharing is disabled in RemoteClaw. iOS currently allows Always."
        case (.off, true, .authorizedWhenInUse, _):
            "Location sharing is disabled in RemoteClaw. iOS currently allows While Using."
        case (.off, _, _, _):
        ...
        @unknown default:
            "RemoteClaw cannot determine the current iOS location permission."
        }
    }
}
