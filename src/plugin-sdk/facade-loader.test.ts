...
const originalBundledPluginsDir = process.env.REMOTECLAW_BUNDLED_PLUGINS_DIR;
const FACADE_LOADER_GLOBAL = "__remoteclawTestLoadBundledPluginPublicSurfaceModuleSync";
...
afterEach(() => {
  ...
  if (originalBundledPluginsDir === undefined) {
    ...
    process.env.REMOTECLAW_BUNDLED_PLUGINS_DIR = originalBundledPluginsDir;
  }
});

describe("plugin-sdk facade loader", () => {
  it("honors bundled plugin dir overrides outside the package root", () => {
    const overrideA = createBundledPluginDir("remoteclaw-facade-loader-a-", "override-a");
    const overrideB = createBundledPluginDir("remoteclaw-facade-loader-b-", "override-b");

    process.env.REMOTECLAW_BUNDLED_PLUGINS_DIR = overrideA;
    ...
    process.env.REMOTECLAW_BUNDLED_PLUGINS_DIR = overrideB;
  ...
  it("shares loaded facade ids with facade-runtime", () => {
    const dir = createBundledPluginDir("remoteclaw-facade-loader-ids-", "identity-check");
    process.env.REMOTECLAW_BUNDLED_PLUGINS_DIR = dir;
  ...
  it("keeps Windows dist facade loads off Jiti native import", () => {
    const dir = createTempDirSync("remoteclaw-facade-loader-windows-dist-");
    ...
    process.env.REMOTECLAW_BUNDLED_PLUGINS_DIR = bundledPluginsDir;
  ...
  it("breaks circular facade re-entry during module evaluation", () => {
    const dir = createCircularPluginDir("remoteclaw-facade-loader-circular-");
    process.env.REMOTECLAW_BUNDLED_PLUGINS_DIR = dir;
  ...
  it("clears the cache on load failure so retries re-execute", () => {
    const dir = createThrowingPluginDir("remoteclaw-facade-loader-throw-");
    process.env.REMOTECLAW_BUNDLED_PLUGINS_DIR = dir;
