...
export const MODULE_ATTESTATIONS = {
  markCodeModeControlTool: "live",
  isCodeModeControlTool: "live",
  getCodeModeExecBeforeHookMetadata: "live",
  getCodeModeExecBeforeHookMetadataForToolKind: "live",
  normalizeCodeModeExecBeforeHookParams: "live",
  normalizeCodeModeExecBeforeHookParamsForToolKind: "live",
  reconcileCodeModeExecBeforeHookParams: "live",
} as const;
