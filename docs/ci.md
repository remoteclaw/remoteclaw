...
| `blacksmith-12vcpu-macos-26`     | `macos-swift` on `remoteclaw/remoteclaw`; forks fall back to `macos-26`                                                                                                                                                             |
...
| `REMOTECLAW_DOCKER_ALL_NPM_LIMIT`        | 10      | Concurrent npm install lane cap.                                                              |
