...
export const es: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      qrAlt: "Código QR de vinculación de RemoteClaw móvil",
      ...
      review: "Revisión",
      waiting:
        "Las apps móviles oficiales de RemoteClaw se conectan automáticamente después de escanear.",
  ...
  worktrees: {
    ...
    subtitle: "Checkouts de repositorios aislados propiedad de RemoteClaw.",
  ...
  subtitles: {
    ...
    config: "Editar ~/.remoteclaw/remoteclaw.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde remoteclaw dashboard --no-open en tu escritorio.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — vuelve a autenticarte con remoteclaw models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Pega el token de remoteclaw dashboard --no-open o introduce la contraseña configurada.",
        stepGenerate:
          "Si no hay token configurado, ejecuta remoteclaw doctor --generate-gateway-token en el host del Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Ejecuta remoteclaw dashboard --no-open y abre la URL nueva o pega su token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Ejecuta remoteclaw devices list en el host del Gateway.",
        stepApproveId: "Aprueba esta solicitud: remoteclaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Vuelve a abrir el dashboard servido con remoteclaw dashboard para que UI y Gateway provengan de la misma instalación.",
        stepDevUi:
          "Si usas pnpm ui:dev, reconstruye o reinicia la UI de desarrollo contra el checkout actual.",
        stepRestart:
          "Reinicia el Gateway después de actualizar RemoteClaw para que sirva el protocolo actual.",
      },
      network: {
        ...
        stepGateway:
          "Confirma que el Gateway esté en ejecución con remoteclaw status u remoteclaw gateway run.",
        stepUrl:
          "Revisa la URL de WebSocket y usa wss:// cuando el Gateway esté detrás de HTTPS/Tailscale Serve.",
        stepDashboard:
          "Vuelve a abrir el dashboard con remoteclaw dashboard --no-open para copiar la URL y los detalles de autenticación actuales.",
      },
    },
  },
  connection: {
