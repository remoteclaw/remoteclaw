...
const DEFAULT_HOST_PATH = "~/.remoteclaw/exec-approvals.json";
...
function formatRequestedSource(params: {
  ...
  return params.sourcePath === "__default__"
    ? `RemoteClaw default (${params.defaultValue})`
...
function formatHostFieldSource(params: {
  ...
  if (params.field === "askFallback") {
    return `RemoteClaw default (${DEFAULT_EXEC_APPROVAL_ASK_FALLBACK})`;
  }
