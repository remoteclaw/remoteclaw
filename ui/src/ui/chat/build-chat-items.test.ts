      ...
      toolMessages: [
        {
          ...
          content: JSON.stringify({
            ...
            view: {
              backend: "canvas",
              id: "cv_nearest_turn",
              url: "/__remoteclaw__/canvas/documents/cv_nearest_turn/index.html",
          ...
          content: JSON.stringify({
            selected_item: {
              ...
              view: {
                ...
                url: "/__remoteclaw__/canvas/documents/cv_generic_inline/index.html",
            ...
            },
            {
              ...
              text: JSON.stringify({
                ...
                view: {
                  ...
                  url: "/__remoteclaw__/canvas/documents/cv_streamed_artifact/index.html",
                  title: "Streamed demo",
                  preferred_height: 320,
                },
                presentation: {
