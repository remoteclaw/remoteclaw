...
function resolveDefaultAgentId(cfg: RemoteClawConfig): string {
...
function listBoundAccountIds(cfg: RemoteClawConfig, channelId: string): string[] {
  const ids = new Set<string>();
...
function resolveDefaultAgentBoundAccountId(cfg: RemoteClawConfig, channelId: string): string | null {
...
export function resolveDefaultTelegramAccountSelection(cfg: RemoteClawConfig): {
  accountId: string;
  accountIds: string[];
