...
if [[ -z "$version_content" ]]; then
  echo "<h2>RemoteClaw $VERSION</h2>"
  echo "<p>Latest RemoteClaw update.</p>"
  echo "<p><a href=\"https://github.com/remoteclaw/remoteclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
