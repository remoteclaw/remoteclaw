...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "org.remoteclaw", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("RemoteClaw/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__remoteclaw__/a2ui/").absoluteString + "?platform=macos"
    }
