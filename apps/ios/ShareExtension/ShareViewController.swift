...
final class ShareViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        self.sendButton.setTitle(
            NSLocalizedString("Send to RemoteClaw", comment: "Share extension send action"),
            for: .normal)
    ...
    private func sendCurrentDraft() async {
        ...
        self.showStatus(NSLocalizedString("Sending to RemoteClaw gateway…", comment: "Share extension sending status"))
        ...
        do {
            ...
            self.showStatus(NSLocalizedString("Sent to RemoteClaw.", comment: "Share extension success status"))
    ...
    private func sendMessageToGateway(_ message: String, attachments: [ShareAttachment]) async throws {
        ...
        do {
            try await gateway.connect(
                ...
                connectOptions: makeOptions("remoteclaw-ios"),
                sessionBox: nil,
                onConnected: {},
                onDisconnected: { _ in },
                onInvoke: { req in
