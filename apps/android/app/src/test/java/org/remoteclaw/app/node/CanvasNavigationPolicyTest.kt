...
class CanvasNavigationPolicyTest {
  ...
  fun keepsRemoteEmulatorBridgeAndBundledUrls() {
    val accepted =
      listOf(
        ...
        "http://gateway.local:18789/__remoteclaw__/canvas/",
        "http://10.0.2.2:18789/__remoteclaw__/canvas/",
  ...
  fun controllerUsesSharedPolicyForDirectLoads() {
    ...
    controller.navigate("http://10.0.2.2:18789/__remoteclaw__/canvas/")
    assertEquals("http://10.0.2.2:18789/__remoteclaw__/canvas/", controller.currentUrl())
  }
