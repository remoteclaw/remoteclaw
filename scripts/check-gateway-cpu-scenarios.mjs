  ...
  return {
    ...
    ...(qaState
      ? {
          ...
          REMOTECLAW_HOME: qaState.home,
          REMOTECLAW_STATE_DIR: qaState.stateDir,
          REMOTECLAW_CONFIG_PATH: qaState.configPath,
        }
      : {}),
    REMOTECLAW_BUILD_PRIVATE_QA: "1",
    REMOTECLAW_ENABLE_PRIVATE_QA_CLI: "1",
    REMOTECLAW_RUN_NODE_SKIP_DTS_BUILD: env.REMOTECLAW_RUN_NODE_SKIP_DTS_BUILD ?? "1",
    REMOTECLAW_TEST_DISABLE_UPDATE_CHECK: env.REMOTECLAW_TEST_DISABLE_UPDATE_CHECK ?? "1",
  };
}
