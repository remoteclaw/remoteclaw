...
describe("plugin-sdk subpath exports", () => {
  ...
  it("keeps runtime entry subpaths importable", async () => {
    const [
      ...
      importResolvedPluginSdkSubpath("remoteclaw/plugin-sdk/core"),
      importResolvedPluginSdkSubpath("remoteclaw/plugin-sdk/plugin-entry"),
      importResolvedPluginSdkSubpath("remoteclaw/plugin-sdk/infra-runtime"),
      importResolvedPluginSdkSubpath("remoteclaw/plugin-sdk/channel-lifecycle"),
      importResolvedPluginSdkSubpath("remoteclaw/plugin-sdk/channel-pairing"),
      importResolvedPluginSdkSubpath("remoteclaw/plugin-sdk/channel-reply-pipeline"),
      ...representativeRuntimeSmokeSubpaths.map((id) =>
        importResolvedPluginSdkSubpath(`remoteclaw/plugin-sdk/${id}`),
      ),
    ]);
