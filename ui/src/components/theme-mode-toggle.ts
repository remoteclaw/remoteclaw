...
class ThemeModeToggle extends LitElement {
  ...
  override render() {
    ...
    return html`
      <remoteclaw-tooltip .content=${tooltip}>
        <button
          type="button"
...
if (!customElements.get("remoteclaw-theme-mode-toggle")) {
  customElements.define("remoteclaw-theme-mode-toggle", ThemeModeToggle);
}
