...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.REMOTECLAW_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.REMOTECLAW_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.REMOTECLAW_WATCH_COMMAND),
