...
describe("gateway bonjour advertiser", () => {
  ...
  it("suppresses ciao self-probe retry console noise while advertising", async () => {
    ...
    try {
      ...
      console.log(
        "[test._remoteclaw-gw._tcp.local.] failed probing with reason: Error: Can't probe for a service which is announced already. Received announcing for service test._remoteclaw-gw._tcp.local.. Trying again in 2 seconds!",
      );
