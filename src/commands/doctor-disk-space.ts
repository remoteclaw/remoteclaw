 ...
 *
 * This catches a common operational failure mode where RemoteClaw silently
...
export function noteDiskSpace(
  _cfg: RemoteClawConfig, // reserved for API consistency with other Doctor contributions
  deps?: {
