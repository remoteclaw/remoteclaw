...
const SANDBOX_EXAMPLES = {
  main: [
    ["remoteclaw sandbox list", "List all sandbox containers."],
    ["remoteclaw sandbox list --browser", "List only browser containers."],
    ["remoteclaw sandbox recreate --all", "Recreate all containers."],
    ["remoteclaw sandbox recreate --session main", "Recreate a specific session."],
    ["remoteclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["remoteclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["remoteclaw sandbox list", "List all sandbox containers."],
    ["remoteclaw sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ...
    ["remoteclaw sandbox recreate --session main", "Recreate a specific session."],
    [
      "remoteclaw sandbox recreate --agent mybot",
      "Recreate a specific agent (includes sub-agents).",
    ],
    ["remoteclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["remoteclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["remoteclaw sandbox explain", "Show effective sandbox config."],
    ["remoteclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["remoteclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["remoteclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.remoteclaw.ai/cli/sandbox")}\n`,
    )
    .action(() => {
