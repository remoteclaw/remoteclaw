---
description: "Use Synthetic's Anthropic-compatible API in RemoteClaw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. RemoteClaw registers it as the
...
```bash
remoteclaw onboard --auth-choice synthetic-api-key
```
