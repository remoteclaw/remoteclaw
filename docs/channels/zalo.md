...
1. Install the Zalo plugin:
   - From a source checkout: `remoteclaw plugins install ./path/to/local/zalo-plugin`
   - From npm (if published): `remoteclaw plugins install @remoteclaw/zalo`
...
This page reflects current RemoteClaw behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `remoteclaw pairing list zalo`
  - `remoteclaw pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in RemoteClaw.
...
- Example: `remoteclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `remoteclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `remoteclaw logs --follow`
