...
describe("bundled plugin build entries", () => {
  it("includes manifest-less runtime core support packages in dist build entries", () => {
    ...
    expect(entries).toMatchObject({
      ...
      "extensions/image-generation-core/runtime-api": "extensions/image-generation-core/runtime-api.ts",
      "extensions/media-understanding-core/runtime-api": "extensions/media-understanding-core/runtime-api.ts",
  ...
  it("packs runtime core support packages without requiring plugin manifests", () => {
    ...
    expect(artifacts).not.toContain("dist/extensions/image-generation-core/remoteclaw.plugin.json");
    expect(artifacts).toContain("dist/extensions/media-understanding-core/runtime-api.js");
    expect(artifacts).not.toContain("dist/extensions/media-understanding-core/remoteclaw.plugin.json");
    expect(artifacts).toContain("dist/extensions/speech-core/runtime-api.js");
    expect(artifacts).not.toContain("dist/extensions/speech-core/remoteclaw.plugin.json");
  });
});
