...
vi.mock("remoteclaw/plugin-sdk/channel-feedback", () => ({
  DEFAULT_TIMING: {
    doneHoldMs: 0,
    errorHoldMs: 0,
  },
...
vi.mock("remoteclaw/plugin-sdk/channel-reply-pipeline", () => ({
...
vi.mock("remoteclaw/plugin-sdk/channel-streaming", () => ({
  resolveChannelStreamingBlockEnabled: () => false,
  resolveChannelStreamingNativeTransport: () => false,
}));

vi.mock("remoteclaw/plugin-sdk/outbound-runtime", () => ({
  resolveAgentOutboundIdentity: () => undefined,
}));

vi.mock("remoteclaw/plugin-sdk/reply-history", () => ({
  clearHistoryEntriesIfEnabled: () => {},
}));

vi.mock("remoteclaw/plugin-sdk/reply-payload", () => ({
...
vi.mock("remoteclaw/plugin-sdk/security-runtime", () => ({
...
vi.mock("../config.runtime.js", () => ({
  resolveStorePath: () => "/tmp/remoteclaw-store.json",
