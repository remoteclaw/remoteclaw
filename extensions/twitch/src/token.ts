 ...
 * The REMOTECLAW_TWITCH_ACCESS_TOKEN env var is only used for the default account.
 *
...
export function resolveTwitchToken(
  ...
  const envToken = allowEnv
    ? normalizeTwitchToken(opts.envToken ?? process.env.REMOTECLAW_TWITCH_ACCESS_TOKEN)
    : undefined;
  if (envToken) {
