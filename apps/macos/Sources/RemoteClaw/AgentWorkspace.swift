...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "org.remoteclaw", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return RemoteClawConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultTemplate() -> String {
        let fallback = """
        # AGENTS.md - RemoteClaw Workspace
