...
#
# Suggested cron: */30 * * * * /home/admin/remoteclaw/scripts/auth-monitor.sh
#
...
if [ "$DIFF_MS" -lt 0 ]; then
    send_notification "Claude Code auth EXPIRED! RemoteClaw is down. Run: ssh l36 '~/remoteclaw/scripts/mobile-reauth.sh'" "urgent"
    exit 1
