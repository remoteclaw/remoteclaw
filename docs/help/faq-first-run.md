...
<AccordionGroup>
  ...
  <Accordion title="Why does RemoteClaw still mention openai-codex?">
    ...
    - `openai-codex/gpt-5.5` = legacy model route repaired by `remoteclaw doctor --fix`
    ...
    `remoteclaw models auth login --provider openai-codex`. Keep the model ref as
