...
export const nl: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      qrAlt: "QR-code voor koppeling met RemoteClaw mobiel",
      ...
      review: "Beoordeling",
      waiting: "Officiële mobiele RemoteClaw-apps verbinden automatisch na het scannen.",
  ...
  worktrees: {
    ...
    subtitle: "Geïsoleerde repository-checkouts beheerd door RemoteClaw.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Op mobiel? Kopieer de volledige URL (inclusief #token=...) vanuit remoteclaw dashboard --no-open op je desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — authenticeer opnieuw met remoteclaw models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Plak het token uit remoteclaw dashboard --no-open of voer het geconfigureerde wachtwoord in.",
        stepGenerate:
          "Als er geen token is geconfigureerd, voer dan remoteclaw doctor --generate-gateway-token uit op de Gateway-host.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Voer remoteclaw dashboard --no-open uit en open de nieuwe URL of plak het token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Voer remoteclaw devices list uit op de Gateway-host.",
        stepApproveId: "Keur deze aanvraag goed: remoteclaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Open het geserveerde dashboard opnieuw met remoteclaw dashboard zodat UI en Gateway uit dezelfde installatie komen.",
        stepDevUi:
          "Als je pnpm ui:dev gebruikt, bouw of herstart de dev-UI tegen de huidige checkout.",
        stepRestart:
          "Herstart de Gateway na het bijwerken van RemoteClaw zodat het huidige protocol wordt geserveerd.",
      },
      network: {
        ...
        stepGateway:
          "Bevestig dat de Gateway draait met remoteclaw status of remoteclaw gateway run.",
        stepUrl:
          "Controleer de WebSocket-URL en gebruik wss:// wanneer de Gateway achter HTTPS/Tailscale Serve staat.",
        stepDashboard:
          "Open het dashboard opnieuw met remoteclaw dashboard --no-open om de huidige URL en authdetails opnieuw te kopiëren.",
      },
    },
  },
  connection: {
