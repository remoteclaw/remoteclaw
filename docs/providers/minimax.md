---
summary: "Use MiniMax M2.5 in RemoteClaw"
read_when:
...
```bash
remoteclaw plugins enable minimax  # skip if already loaded.
...
See [MiniMax plugin README](https://github.com/remoteclaw/remoteclaw/tree/main/extensions/minimax) for details.
...
- Use `remoteclaw models list` and `remoteclaw models set minimax/MiniMax-M2.5` to switch.
...
- Running `remoteclaw configure` and selecting **MiniMax M2.5**, or
