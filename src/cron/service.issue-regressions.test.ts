...
describe("Cron issue regressions", () => {
  ...
  // Gutted in RemoteClaw fork — one-shot transient retry logic not present
  it.skip("#24355: one-shot retries then succeeds (with and without deleteAfterRun)", async () => {
