...
This directory contains the **BlueBubbles external channel plugin** for RemoteClaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `remoteclaw/plugin-sdk` helpers.
