...
public final class GatewayDiscoveryModel {
    ...
    public func start() {
        ...
        for domain in RemoteClawBonjour.gatewayServiceDomains {
            let browser = GatewayDiscoveryBrowserSupport.makeBrowser(
                ...
                domain: domain,
                queueLabelPrefix: "org.remoteclaw.macos.gateway-discovery",
    ...
    public func refreshWideAreaFallbackNow(timeoutSeconds: TimeInterval = 5.0) {
        guard let domain = RemoteClawBonjour.wideAreaGatewayServiceDomain else { return }
    ...
    private func updateGateways(for domain: String) {
        ...
        if let wideAreaDomain = RemoteClawBonjour.wideAreaGatewayServiceDomain,
    ...
    private nonisolated static func prettifyInstanceName(_ decodedName: String) -> String {
        ...
        let stripped = normalized.replacingOccurrences(of: " (RemoteClaw)", with: "")
