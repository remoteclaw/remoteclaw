...
export const pl: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      qrAlt: "Kod QR parowania RemoteClaw mobile",
      ...
      review: "Do przeglądu",
      waiting: "Oficjalne aplikacje mobilne RemoteClaw łączą się automatycznie po zeskanowaniu.",
  ...
  worktrees: {
    ...
    subtitle: "Izolowane kopie robocze repozytoriów należące do RemoteClaw.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Na urządzeniu mobilnym? Skopiuj pełny URL (w tym #token=...) z remoteclaw dashboard --no-open na komputerze.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — uwierzytelnij ponownie za pomocą remoteclaw models auth",
