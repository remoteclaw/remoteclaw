...
async function runRuntimeWebTools(params: { config: RemoteClawConfig; env?: NodeJS.ProcessEnv }) {
...
function readProviderKey(config: RemoteClawConfig, provider: ProviderUnderTest): unknown {
