...
Spotted an attack vector or risk we haven't covered? Open an issue on [remoteclaw/trust](https://github.com/remoteclaw/trust/issues) and describe it in your own words. You don't need to know any frameworks or fill in every field - just describe the scenario.
...
Contributors to the threat model are recognized in the threat model acknowledgments, release notes, and the RemoteClaw security hall of fame for significant contributions.
