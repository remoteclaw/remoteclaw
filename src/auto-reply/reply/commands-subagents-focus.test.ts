...
describe("/focus, /unfocus, /agents", () => {
  ...
  // Gutted in RemoteClaw fork — readAcpSessionEntry is a local stub returning undefined (Middleware Boundary Principle)
  it.skip("/focus resolves ACP sessions and binds the current Discord thread", async () => {
  ...
  // Gutted in RemoteClaw fork — readAcpSessionEntry is a local stub returning undefined (Middleware Boundary Principle)
  it.skip("/focus includes ACP session identifiers in intro text when available", async () => {
