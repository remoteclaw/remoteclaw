...
agent directory (default `~/.remoteclaw/agents/<agentId>/agent/models.json`). This file
...
This applies whenever RemoteClaw regenerates `models.json`, including command-driven paths like `remoteclaw agent`.
