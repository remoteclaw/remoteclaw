...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "org.remoteclaw.app", category: "LiveActivity")
    ...
    private func updateCurrent(state: RemoteClawActivityAttributes.ContentState, staleDate: Date? = nil) {
    ...
    private func end(activity: Activity<RemoteClawActivityAttributes>) {
        Task {
            await activity.end(
                ActivityContent(state: self.disconnectedState(), staleDate: nil),
                dismissalPolicy: .immediate)
    ...
    private func connectingState(statusText: String = "Connecting...") -> RemoteClawActivityAttributes.ContentState {
    ...
    private func attentionState(statusText: String) -> RemoteClawActivityAttributes.ContentState {
        RemoteClawActivityAttributes.ContentState(
            statusText: statusText,
            isIdle: false,
            isDisconnected: false,
