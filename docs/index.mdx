...
<p align="center">
  <img src="/assets/remoteclaw-logo-text-dark.png" alt="RemoteClaw" width="500" class="dark:sl-hidden" />
  <img src="/assets/remoteclaw-logo-text.png" alt="RemoteClaw" width="500" class="light:sl-hidden" />
</p>

<p align="center">
  <strong>
    Any OS gateway for AI agents across 20+ channels — WhatsApp, Telegram, Discord, iMessage, Signal, Slack, Matrix, and
    more.
  </strong>
  <br />
...
<CardGrid>
  <Card title="Multi-channel gateway">WhatsApp, Telegram, Discord, and iMessage with a single Gateway process.</Card>
