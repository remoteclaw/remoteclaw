...
import { restoreStateDirEnv, setStateDirEnv, snapshotStateDirEnv, withStateDirEnv } from "./state-dir-env.js";
...
describe("state-dir-env helpers", () => {
  it("set/snapshot/restore round-trips REMOTECLAW_STATE_DIR", () => {
