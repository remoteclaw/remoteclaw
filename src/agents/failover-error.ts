...
type FailoverReason =
  ...
  | "session_expired"
  | "unknown";
const classifyFailoverReason = (..._args: unknown[]): FailoverReason | null => null;
const isAuthPermanentErrorMessage = (..._args: unknown[]): boolean => false;
const isTimeoutErrorMessage = (..._args: unknown[]): boolean => false;
