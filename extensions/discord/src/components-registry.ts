...
const DISCORD_COMPONENT_ENTRIES_KEY = Symbol.for("remoteclaw.discord.componentEntries");
const DISCORD_MODAL_ENTRIES_KEY = Symbol.for("remoteclaw.discord.modalEntries");
