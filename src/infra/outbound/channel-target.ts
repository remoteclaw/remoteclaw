...
export function applyTargetToParams(params: { action: string; args: Record<string, unknown> }): void {
  ...
  const mode = MESSAGE_ACTION_TARGET_MODE[params.action as keyof typeof MESSAGE_ACTION_TARGET_MODE] ?? "none";
