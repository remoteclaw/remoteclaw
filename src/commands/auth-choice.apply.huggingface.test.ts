// Gutted in RemoteClaw fork — applyAuthChoiceHuggingface is a no-op stub
...
describe.skip("applyAuthChoiceHuggingface", () => {
  ...
  async function setupTempState() {
    const env = await setupAuthTestEnv("remoteclaw-hf-");
      ...
      (
        result as {
          config: {
            ...
            agents?: {
              defaults?: { model?: import("../config/types.agents-shared.js").AgentModelConfig };
            };
          };
        }
      ).config.auth?.profiles?.["huggingface:default"],
    ).toMatchObject({
          ...
          (
            result as {
              config: {
                ...
                agents?: {
                  defaults?: {
                    model?: import("../config/types.agents-shared.js").AgentModelConfig;
                  };
                };
              };
            }
