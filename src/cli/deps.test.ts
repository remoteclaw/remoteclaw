...
describe("createDefaultDeps", () => {
  ...
  it("does not load provider modules until a dependency is used", async () => {
    ...
    const sendTelegram = deps.sendMessageTelegram as unknown as (...args: unknown[]) => Promise<unknown>;
  ...
  it("reuses module cache after first dynamic import", async () => {
    const deps = createDefaultDeps();
    const sendDiscord = deps.sendMessageDiscord as unknown as (...args: unknown[]) => Promise<unknown>;
