...
describe("tailscale helpers", () => {
  ...
  beforeEach(() => {
    envSnapshot = captureEnv(["REMOTECLAW_TEST_TAILSCALE_BINARY", "NODE_ENV", "VITEST"]);
  ...
  it("allows the test binary override in explicit test environments", () => {
    process.env.REMOTECLAW_TEST_TAILSCALE_BINARY = "/tmp/test-tailscale";
  ...
  it("ignores the test binary override outside test environments", () => {
    process.env.REMOTECLAW_TEST_TAILSCALE_BINARY = "/tmp/attacker-tailscale";
