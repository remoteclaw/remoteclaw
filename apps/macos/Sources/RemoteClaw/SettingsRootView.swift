...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .remoteclawSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? RemoteClawPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? RemoteClawPaths.stateDirURL.path
...
extension Notification.Name {
    static let remoteclawSelectSettingsTab = Notification.Name("remoteclawSelectSettingsTab")
}
