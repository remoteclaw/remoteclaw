...
const CATALOGS = [
  {
    ...
    coverage: {
      ...
      "apps/ios/Sources/Design/ChatProTab.swift": [
        ...
        "Summarize the current RemoteClaw status and tell me what needs attention.",
      ...
      "apps/shared/RemoteClawKit/Sources/RemoteClawChatUI/ChatMessageViews.swift": ["Writing"],
    },
  },
  {
    path: "apps/macos/Sources/RemoteClaw/Resources/Localizable.xcstrings",
    coverage: {
      "apps/macos/Sources/RemoteClaw/ChannelsSettings+ChannelSections.swift": [
        "Logout",
        "Refresh",
        "Save",
      ],
      "apps/macos/Sources/RemoteClaw/CronSettings+Rows.swift": ["Run now"],
    },
  },
] as const;
