...
export const A2UI_PATH = "/__remoteclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__remoteclaw__/canvas";

export const CANVAS_WS_PATH = "/__remoteclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.remoteclawCanvasA2UIAction.postMessage(...)
  // - Android: window.remoteclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["remoteclawCanvasA2UIAction"];
  ...
  globalThis.RemoteClaw = globalThis.RemoteClaw ?? {};
  globalThis.RemoteClaw.postMessage = postToNode;
  globalThis.RemoteClaw.sendUserAction = sendUserAction;
  globalThis.remoteclawPostMessage = postToNode;
  globalThis.remoteclawSendUserAction = sendUserAction;
