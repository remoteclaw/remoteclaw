...
function sanitizeBundledManifestForRuntimeInstall(pluginDir) {
  ...
  if (packageJson.peerDependencies?.remoteclaw) {
    const nextPeerDependencies = { ...packageJson.peerDependencies };
    delete nextPeerDependencies.remoteclaw;
  ...
  if (packageJson.peerDependenciesMeta?.remoteclaw) {
    const nextPeerDependenciesMeta = { ...packageJson.peerDependenciesMeta };
    delete nextPeerDependenciesMeta.remoteclaw;
  ...
  if (packageJson.devDependencies?.remoteclaw) {
    const nextDevDependencies = { ...packageJson.devDependencies };
    delete nextDevDependencies.remoteclaw;
