...
export function resolveTavilySearchConfig(cfg?: RemoteClawConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: RemoteClawConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: RemoteClawConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
