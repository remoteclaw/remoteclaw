...
RemoteClaw “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, RemoteClaw can see that group and respond there.
