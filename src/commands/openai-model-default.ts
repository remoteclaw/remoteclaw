...
export function applyOpenAIProviderConfig(cfg: RemoteClawConfig): RemoteClawConfig {
...
export function applyOpenAIConfig(cfg: RemoteClawConfig): RemoteClawConfig {
