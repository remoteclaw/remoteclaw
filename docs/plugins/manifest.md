...
- Declare exclusive plugin kind in this manifest. Runtime-entry `RemoteClawPluginDefinition.kind` is deprecated and remains only as a compatibility fallback for older plugins.
