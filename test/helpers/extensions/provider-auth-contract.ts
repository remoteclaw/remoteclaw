...
vi.mock("remoteclaw/plugin-sdk/provider-auth-login", async (importOriginal) => {
  const actual = await importOriginal<typeof import("remoteclaw/plugin-sdk/provider-auth-login")>();
  return {
    ...actual,
...
vi.mock("remoteclaw/plugin-sdk/provider-auth", async (importOriginal) => {
  const actual = await importOriginal<typeof import("remoteclaw/plugin-sdk/provider-auth")>();
  return {
    ...actual,
