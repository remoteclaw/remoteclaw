...
describe("debug proxy runtime", () => {
  const envKeys = [
    "REMOTECLAW_DEBUG_PROXY_ENABLED",
    "REMOTECLAW_DEBUG_PROXY_DB_PATH",
    "REMOTECLAW_DEBUG_PROXY_BLOB_DIR",
    "REMOTECLAW_DEBUG_PROXY_SESSION_ID",
    "REMOTECLAW_DEBUG_PROXY_SOURCE_PROCESS",
  ] as const;
  ...
  beforeEach(() => {
    ...
    process.env.REMOTECLAW_DEBUG_PROXY_ENABLED = "1";
    process.env.REMOTECLAW_DEBUG_PROXY_DB_PATH = "/tmp/remoteclaw-proxy-runtime-test.sqlite";
    process.env.REMOTECLAW_DEBUG_PROXY_BLOB_DIR = "/tmp/remoteclaw-proxy-runtime-test-blobs";
    process.env.REMOTECLAW_DEBUG_PROXY_SESSION_ID = "runtime-test-session";
    process.env.REMOTECLAW_DEBUG_PROXY_SOURCE_PROCESS = "runtime-test";
  });
