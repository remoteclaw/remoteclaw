...
# Update service file
SERVICE_FILE="$SCRIPT_DIR/systemd/remoteclaw-auth-monitor.service"
...
cp "$SCRIPT_DIR/systemd/remoteclaw-auth-monitor.service" ~/.config/systemd/user/
cp "$SCRIPT_DIR/systemd/remoteclaw-auth-monitor.timer" ~/.config/systemd/user/
