...
enum ChatSessionSidebarModel {
    struct Section: Identifiable, Equatable {
        let id: String
        let title: String?
        let sessions: [RemoteClawChatSessionEntry]
    }
    ...
    static func displayName(for session: RemoteClawChatSessionEntry) -> String {
        ...
        activeAgentID: String?) -> String
    {
        ...
        return sessions.first(where: {
            RemoteClawChatViewModel.matchesCurrentSessionKey(
                incoming: $0.key,
    ...
    private static func visibleSessions(
        ...
        query: String) -> [RemoteClawChatSessionEntry]
    {
    ...
    private static func placeholder(key: String) -> RemoteClawChatSessionEntry {
