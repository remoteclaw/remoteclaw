...
/**
 * Convert an RemoteClaw auth-profiles credential to pi-coding-agent auth.json format.
 ...
 *
 * RemoteClaw stores credentials in auth-profiles.json instead. This helper
