...
RemoteClaw keeps up to five numbered archives beside the active file, such as
`remoteclaw-YYYY-MM-DD.1.log`, and keeps writing to a fresh active log instead of
suppressing diagnostics.

You can override this in `~/.remoteclaw/remoteclaw.json`:
