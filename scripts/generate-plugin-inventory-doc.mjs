...
function resolveStatus({ dirName, packageJson, excludedDirs }) {
  ...
  const hasInstallSpec =
    typeof packageJson.remoteclaw?.install?.clawhubSpec === "string" ||
...
- **Official external package:** RemoteClaw-maintained plugin omitted from the core npm package and installed through ClawHub and/or npm.
