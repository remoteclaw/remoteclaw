...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "org.remoteclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other RemoteClaw windows, but below the system’s pop-up menus.
