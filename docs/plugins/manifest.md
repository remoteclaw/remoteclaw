...
Every plugin **must** ship a `remoteclaw.plugin.json` file in the **plugin root**.
RemoteClaw uses this manifest to validate configuration **without executing plugin
