...
const extensionRestartMetadataFiles = new Set(["remoteclaw.plugin.json", "package.json"]);
...
const shouldSkipCleanWatchRuntimeSync = (deps) => deps.env.REMOTECLAW_WATCH_MODE === "1";
