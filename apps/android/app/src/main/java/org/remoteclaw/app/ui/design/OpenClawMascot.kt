...
/**
 * Animated RemoteClaw mascot mirroring the remoteclaw.org hero mark: body float,
...
private fun rememberMascotPose(): MascotPose {
  ...
  val transition = rememberInfiniteTransition(label = "remoteclawMascot")
  val floatOffset =
