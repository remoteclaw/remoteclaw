...
export const pt_BR: TranslationMap = {
  ...
  nodes: {
    pairing: {
      ...
      qrAlt: "Código QR de pareamento do RemoteClaw mobile",
      ...
      review: "Revisão",
      waiting: "Os apps móveis oficiais do RemoteClaw se conectam automaticamente após a leitura.",
  ...
  worktrees: {
    ...
    subtitle: "Checkouts isolados de repositórios pertencentes ao RemoteClaw.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "No celular? Copie a URL completa (incluindo #token=...) executando remoteclaw dashboard --no-open no desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — autentique novamente com remoteclaw models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste: "Cole o token de remoteclaw dashboard --no-open ou informe a senha configurada.",
        stepGenerate:
          "Se nenhum token estiver configurado, execute remoteclaw doctor --generate-gateway-token no host do Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Execute remoteclaw dashboard --no-open e abra o novo URL ou cole seu token.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Execute remoteclaw devices list no host do Gateway.",
        stepApproveId: "Aprove esta solicitação: remoteclaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Reabra o dashboard servido com remoteclaw dashboard para que UI e Gateway venham da mesma instalação.",
        stepDevUi:
          "Se estiver usando pnpm ui:dev, reconstrua ou reinicie a UI de desenvolvimento com o checkout atual.",
        stepRestart:
          "Reinicie o Gateway depois de atualizar o RemoteClaw para que ele sirva o protocolo atual.",
      },
      network: {
        ...
        stepGateway:
          "Confirme que o Gateway está em execução com remoteclaw status ou remoteclaw gateway run.",
        stepUrl:
          "Verifique o URL de WebSocket e use wss:// quando o Gateway estiver atrás de HTTPS/Tailscale Serve.",
        stepDashboard:
          "Reabra o dashboard com remoteclaw dashboard --no-open para copiar novamente o URL atual e os detalhes de auth.",
      },
    },
  },
  connection: {
