...
- If RemoteClaw has usage metadata and local pricing for the active model,
...
Anthropic still does not expose a per-message dollar estimate that RemoteClaw can
show in `/usage full`.
